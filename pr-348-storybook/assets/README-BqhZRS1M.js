...
`,(0,S.jsxs)(t.li,{children:[(0,S.jsx)(t.code,{children:`sm`}),`, `,(0,S.jsx)(t.code,{children:`md`}),`, or `,(0,S.jsx)(t.code,{children:`lg`}),` for the adopted components inside (listed below): their text, controls, and
default spacing.`]}),`
...
`,(0,S.jsxs)(t.li,{children:[`Adopted so far by Text, Detail, Heading, Label, Button, LinkButton, TextField, NumberField, Select,
DatePicker, DateRangePicker, Calendar, TextLockup, Modal, Drawer, Popover, and Tooltip. Other
components keep their own size. Layout spacing props keep their meaning: `,(0,S.jsx)(t.code,{children:`gap="md"`}),` is the layout
`,(0,S.jsx)(t.code,{children:`md`}),` gap in any scope.`]}),`
`]}),`
