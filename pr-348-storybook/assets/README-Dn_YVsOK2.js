...
`,(0,w.jsxs)(t.li,{children:[`Without `,(0,w.jsx)(t.code,{children:`size`}),`, `,(0,w.jsx)(t.code,{children:`Text`}),` inherits every font property from what surrounds it: a
`,(0,w.jsx)(t.a,{href:`../size-scope/README.mdx`,children:`SizeScope`}),`, a control, or a named part. So
`,(0,w.jsx)(t.code,{children:`<Button><Text>Save</Text></Button>`}),` looks exactly like `,(0,w.jsx)(t.code,{children:`<Button>Save</Button>`}),`.`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.code,{children:`Detail`}),` applies the detail role at the size scope's tier.`]}),`
...
`,(0,w.jsxs)(t.p,{children:[`Without `,(0,w.jsx)(t.code,{children:`size`}),`, text inherits the typography around it. `,(0,w.jsx)(t.code,{children:`size`}),` picks a step on the body ramp
