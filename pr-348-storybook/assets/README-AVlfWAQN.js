...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:`Steppers`}),`: A stepper is a `,(0,w.jsx)(t.code,{children:`Group`}),` holding `,(0,w.jsx)(t.code,{children:`Button slot="decrement"`}),`, an `,(0,w.jsx)(t.code,{children:`Input`}),`, and `,(0,w.jsx)(t.code,{children:`Button slot="increment"`}),`. Left empty, each button takes its icon and `,(0,w.jsx)(t.code,{children:`variant="control"`}),` from the field, so no icon imports are needed. Compose a bare `,(0,w.jsx)(t.code,{children:`Input`}),` instead for a plain numeric input`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:`Sizes`}),`: The field is a `,(0,w.jsx)(t.a,{href:`../size-provider/README.mdx`,children:`size scope`}),`. `,(0,w.jsx)(t.code,{children:`size`}),` (`,(0,w.jsx)(t.code,{children:`sm`}),`, `,(0,w.jsx)(t.code,{children:`md`}),`, `,(0,w.jsx)(t.code,{children:`lg`}),`) sets its label, input, steppers, description, and error; without it, the field follows the surrounding scope`]}),`
...
`,(0,w.jsxs)(t.p,{children:[(0,w.jsx)(t.code,{children:`size`}),` sets the label, input, and steppers. Without it, the field follows the surrounding size
scope.`]}),`
...
`})}),`
`,(0,w.jsx)(t.h3,{id:`numberfield-1`,children:`NumberField`}),`
