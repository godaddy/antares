...
`,(0,w.jsxs)(t.p,{children:[(0,w.jsx)(t.code,{children:`size`}),` sets the label, input, description, and any control composed inside, here a
`,(0,w.jsx)(t.code,{children:`Button slot="control"`}),`. Without it, the field follows the surrounding size scope.`]}),`
