...
`,(0,y.jsxs)(t.li,{children:[`Renders no element, so it never affects layout. Only Antares components follow it; plain HTML
keeps its own typography, so put copy in `,(0,y.jsx)(t.code,{children:`Text`}),`.`]}),`
`,(0,y.jsxs)(t.li,{children:[`Without any scope, components use `,(0,y.jsx)(t.code,{children:`md`}),`.`]}),`
...
`,(0,y.jsx)(t.code,{children:`size`}),` still wins.`]}),`
`,(0,y.jsx)(i,{of:u,inline:!0}),`
`,(0,y.jsx)(r,{code:`import { Button, Flex, Heading, Input, Label, SizeProvider, Text, TextField, TextLockup } from '@godaddy/antares';
...
`,(0,y.jsx)(r,{code:`import { Button, Detail, Flex, Heading, SizeProvider, Text } from '@godaddy/antares';
...
`,(0,y.jsx)(t.h3,{id:`plain-html`,children:`Plain Html`}),`
`,(0,y.jsxs)(t.p,{children:[`A scope sizes Antares components only. Plain HTML keeps its own typography, so put copy in
`,(0,y.jsx)(t.code,{children:`Text`}),` to follow the scope.`]}),`
`,(0,y.jsx)(i,{of:f,inline:!0}),`
`,(0,y.jsx)(r,{code:`import { SizeProvider, Text } from '@godaddy/antares';
