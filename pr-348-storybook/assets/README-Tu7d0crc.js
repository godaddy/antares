...
`,(0,w.jsxs)(t.p,{children:[`Compare the supported `,(0,w.jsx)(t.code,{children:`sm`}),`, `,(0,w.jsx)(t.code,{children:`md`}),`, and `,(0,w.jsx)(t.code,{children:`lg`}),` visual sizes, plain and with an icon plus control button.
...
`,(0,w.jsx)(r,{code:`import { Button, Group, Input, Label, Select, SelectItem, SelectOptions, Text, TextField } from '@godaddy/antares';
...
`,(0,w.jsx)(t.h2,{id:`sizing-and-typography`,children:`Sizing and typography`}),`
`,(0,w.jsxs)(t.p,{children:[`TextField consumes explicit size, then interface size, then `,(0,w.jsx)(t.code,{children:`md`}),`, and provides that size to its parts.
...
`,(0,w.jsxs)(t.table,{children:[(0,w.jsx)(t.thead,{children:(0,w.jsxs)(t.tr,{children:[(0,w.jsx)(t.th,{children:`Field size`}),(0,w.jsx)(t.th,{children:`Label / input tier`}),(0,w.jsx)(t.th,{children:`Supporting Detail tier`}),(0,w.jsx)(t.th,{children:`Input padding`}),(0,w.jsx)(t.th,{children:`Minimum input height`}),(0,w.jsx)(t.th,{children:`Gap`})]})}),(0,w.jsxs)(t.tbody,{children:[(0,w.jsxs)(t.tr,{children:[(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`sm`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`sm`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`md`})}),(0,w.jsx)(t.td,{children:`1 GU`}),(0,w.jsx)(t.td,{children:`2rem`}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`xs`})})]}),(0,w.jsxs)(t.tr,{children:[(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`md`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`md`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`lg`})}),(0,w.jsx)(t.td,{children:`2 GU`}),(0,w.jsx)(t.td,{children:`2.5rem`}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`sm`})})]}),(0,w.jsxs)(t.tr,{children:[(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`lg`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`lg`})}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`xl`})}),(0,w.jsx)(t.td,{children:`3 GU`}),(0,w.jsx)(t.td,{children:`3rem`}),(0,w.jsx)(t.td,{children:(0,w.jsx)(t.code,{children:`md`})})]})]})]}),`
`,(0,w.jsxs)(t.p,{children:[`These mappings are provisional for pilot review. Supporting text defaults to passive color; errors use
critical color. Owned buttons inherit the field size. Select still supports only `,(0,w.jsx)(t.code,{children:`sm`}),`/`,(0,w.jsx)(t.code,{children:`md`}),`, so a Select
composed into a large field uses its current medium treatment until its later adoption.
Input `,(0,w.jsx)(t.code,{children:`size`}),` remains the native character-width attribute, independent of interface sizing.`]}),`
...
`})}),`
`,(0,w.jsx)(t.h3,{id:`textfield-1`,children:`TextField`}),`
