import{i as e}from"./preload-helper-B4cZKGJ2.js";import{y as t}from"./iframe-BZJ6Z0hs.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-h6dT0MST.js";import{t as c}from"./mdx-react-shim-CY5DZQUq.js";import{Controlled as l,DateRangePickerProps as u,Default as d,Disabled as f,FormatOptions as p,MinMax as m,Props as h,Range as g,WithError as _,n as v,t as y}from"./date-picker.stories-D-NFidYl.js";var b,x=e((()=>{b=`import { DatePicker } from '@godaddy/antares';
...
`}));function P(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(o,{of:y,name:`Overview`}),`
...
`,(0,I.jsxs)(t.p,{children:[`Values are `,(0,I.jsx)(t.code,{children:`CalendarDate`}),` objects. Import the date primitives you need from the `,(0,I.jsx)(t.code,{children:`@godaddy/antares/date`}),` subpath:`]}),`
`,(0,I.jsx)(t.pre,{children:(0,I.jsx)(t.code,{className:`language-tsx`,children:`import { parseDate, today, getLocalTimeZone } from '@godaddy/antares/date';
import { DatePicker } from '@godaddy/antares';

<DatePicker label="Event" defaultValue={parseDate('2024-03-15')} />;
<DatePicker label="Today" defaultValue={today(getLocalTimeZone())} />;
`})}),`
`,(0,I.jsxs)(t.p,{children:[(0,I.jsx)(t.code,{children:`@godaddy/antares/date`}),` re-exports `,(0,I.jsx)(t.a,{href:`https://react-spectrum.adobe.com/internationalized/date/`,rel:`nofollow`,children:(0,I.jsx)(t.code,{children:`@internationalized/date`})}),`, the package behind these date primitives. Locale comes from a host `,(0,I.jsx)(t.code,{children:`<I18nProvider>`}),`. This version has no typed/segmented entry - selection is via the calendar.`]}),`
