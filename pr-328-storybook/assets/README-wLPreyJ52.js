import{i as e}from"./preload-helper-DME-cQh5.js";import{F as t}from"./iframe-DDayzf54.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-YWYTikL_.js";import{t as c}from"./mdx-react-shim-DJpOGK6O.js";import{t as l}from"./runtime-DcPfiwh5.js";import{AccountMenu as u,AvatarButton as d,Default as f,Emphasis as p,Image as m,ImageFallback as h,Props as g,Shapes as _,n as v,t as y}from"./avatar.stories-DhCwgPZC.js";function b(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(o,{of:y,name:`Overview`}),`
...
`,(0,S.jsx)(t.li,{children:`Avatar Button and Account Menu compositions built with Pressable`}),`
`]}),`
...
`,(0,S.jsxs)(t.p,{children:[`Use `,(0,S.jsx)(t.code,{children:`Pressable`}),` to add accessible interaction to an Avatar while preserving its shape.`]}),`
`,(0,S.jsx)(i,{of:d,inline:!0}),`
`,(0,S.jsx)(r,{code:`import { Avatar, Pressable, Text } from '@godaddy/antares';
...
`,(0,S.jsx)(t.p,{children:`Wrap an Avatar in a Pressable inside MenuTrigger for an account or profile menu.`}),`
`,(0,S.jsx)(i,{of:u,inline:!0}),`
`,(0,S.jsx)(r,{code:`import { Avatar, Menu, MenuItem, MenuTrigger, Pressable, Text } from '@godaddy/antares';
...
`,(0,S.jsxs)(t.p,{children:[`When an Avatar triggers an action, compose it with `,(0,S.jsx)(t.code,{children:`Pressable`}),` so the Avatar keeps its own shape and receives the interaction behavior directly. Use this pattern for an Avatar Button, or place it inside `,(0,S.jsx)(t.code,{children:`MenuTrigger`}),` for an Account Menu:`]}),`
`,(0,S.jsx)(t.pre,{children:(0,S.jsx)(t.code,{className:`language-tsx`,children:`<Pressable aria-label="Account menu" onPress={openAccountMenu}>
  <Avatar role="button">
    <Text>UT</Text>
  </Avatar>
</Pressable>
...
`,(0,S.jsxs)(t.li,{children:[`Use `,(0,S.jsx)(t.code,{children:`alt=""`}),` on the Image and `,(0,S.jsx)(t.code,{children:`aria-hidden="true"`}),` on the Avatar when the entire avatar is purely decorative.`]}),`
`,(0,S.jsxs)(t.li,{children:[`Give an Avatar Button or Account Menu an accessible name with `,(0,S.jsx)(t.code,{children:`aria-label`}),` or `,(0,S.jsx)(t.code,{children:`aria-labelledby`}),`.`]}),`
`,(0,S.jsxs)(t.li,{children:[`When using `,(0,S.jsx)(t.code,{children:`Pressable`}),`, provide an interactive role for the non-semantic Avatar child.`]}),`
`]}),`
`,(0,S.jsx)(t.h2,{id:`best-practices`,children:`Best Practices`}),`
`,(0,S.jsxs)(t.ul,{children:[`
`,(0,S.jsxs)(t.li,{children:[`Use Avatar for informational identity; compose it with `,(0,S.jsx)(t.code,{children:`Pressable`}),` for an Avatar Button or Account Menu when it is independently actionable.`]}),`
...
`,(0,S.jsx)(t.pre,{children:(0,S.jsx)(t.code,{className:`language-tsx`,children:`<Avatar>
  <Image />
  <Text />
</Avatar>
`})}),`
