import{i as e}from"./preload-helper-DME-cQh5.js";import{F as t}from"./iframe-BHJbLYpB.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-Bhu2rkqm.js";import{t as c}from"./mdx-react-shim-CLoFPkNh.js";import{t as l}from"./runtime-DcPfiwh5.js";import{ChipGroupProps as u,ChipListProps as d,ControlledSelection as f,Default as p,Disabled as m,EmptyState as h,MenuFilterTrigger as g,Props as _,RemovableChips as v,Sizes as y,ToggleChips as b,Truncation as x,n as S,t as C}from"./chip.stories-DLGTyMHu.js";function w(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(o,{of:C,name:`Overview`}),`
...
`,(0,E.jsxs)(t.li,{children:[`Menu filters with a Chip-like appearance using a rounded `,(0,E.jsx)(t.code,{children:`Button`}),` inside `,(0,E.jsx)(t.code,{children:`MenuTrigger`})]}),`
`]}),`
...
`,(0,E.jsx)(t.p,{children:`Use Removable Chips for user-added filters and tokens. Removing a Chip calls
...
`,(0,E.jsxs)(t.p,{children:[`For a menu with a Chip-like appearance, compose a rounded Button inside
...
`,(0,E.jsxs)(t.p,{children:[`Use a plain string for a simple Chip label. When content is composed, use
`,(0,E.jsx)(t.code,{children:`Text`}),` for the visible label and `,(0,E.jsx)(t.code,{children:`textValue`}),` for the complete accessible value.`]}),`
...
`})}),`
`,(0,E.jsxs)(t.p,{children:[`Set the size on `,(0,E.jsx)(t.code,{children:`ChipGroup`}),` to share it with every Chip. `,(0,E.jsx)(t.code,{children:`ChipList`}),` wraps items
horizontally by default, and its layout props can be customized when needed.`]}),`
`,(0,E.jsxs)(t.p,{children:[`For removable Chips, provide `,(0,E.jsx)(t.code,{children:`onRemove`}),` on the group and add a self-closing
`,(0,E.jsx)(t.code,{children:`Button`}),` with `,(0,E.jsx)(t.code,{children:`slot="remove"`}),`. The callback receives a `,(0,E.jsx)(t.code,{children:`Set`}),` of removed keys;
...
`})}),`
`,(0,E.jsx)(t.p,{children:`For Toggle Chips, use the Chip render prop to show a selected accessory.`}),`
...
`})}),`
`,(0,E.jsx)(t.h3,{id:`menu-filter-button`,children:`Menu filter button`}),`
`,(0,E.jsxs)(t.p,{children:[`When you need a menu with a Chip-like appearance, compose a rounded
`,(0,E.jsx)(t.code,{children:`Button`}),` inside `,(0,E.jsx)(t.code,{children:`MenuTrigger`}),`.`]}),`
...
`,(0,E.jsxs)(t.ul,{children:[`
`,(0,E.jsxs)(t.li,{children:[`Give every `,(0,E.jsx)(t.code,{children:`ChipGroup`}),` a `,(0,E.jsx)(t.code,{children:`Label`}),` or an accessible name such as `,(0,E.jsx)(t.code,{children:`aria-label`}),`.`]}),`
`,(0,E.jsxs)(t.li,{children:[`Use `,(0,E.jsx)(t.code,{children:`textValue`}),` when a Chip contains icons, composed content, or a render prop.`]}),`
...
`,(0,E.jsxs)(t.li,{children:[`Menu filter buttons expose their expanded state through `,(0,E.jsx)(t.code,{children:`MenuTrigger`}),`; provide an accessible name when the visible content is incomplete.`]}),`
`]}),`
...
`,(0,E.jsxs)(t.li,{children:[`For menu filters, use the rounded `,(0,E.jsx)(t.code,{children:`Button`}),` composition shown above.`]}),`
`]}),`
`,(0,E.jsx)(t.h2,{id:`troubleshooting`,children:`Troubleshooting`}),`
`,(0,E.jsx)(t.h3,{id:`a-chip-has-no-accessible-name`,children:`A Chip has no accessible name`}),`
`,(0,E.jsxs)(t.p,{children:[`Add a visible `,(0,E.jsx)(t.code,{children:`Label`}),` to the group or provide `,(0,E.jsx)(t.code,{children:`aria-label`}),`. For composed content,
also provide `,(0,E.jsx)(t.code,{children:`textValue`}),` on the Chip.`]}),`
...
`,(0,E.jsxs)(t.p,{children:[`Use a rounded `,(0,E.jsx)(t.code,{children:`Button`}),` inside `,(0,E.jsx)(t.code,{children:`MenuTrigger`}),`, include the visible value, and add a
