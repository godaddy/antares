import{a as e,i as t}from"./preload-helper-BT3GefEN.js";import{F as n}from"./iframe-C1U0XjdE.js";import{t as r}from"./src-b1cXswyW.js";import{Gt as i,_n as a,en as o,hn as s,it as c,ln as l,on as u,pn as d,t as f,yn as p}from"./antares-DND1z0I-.js";import{t as m}from"./src-BHEj3QyO.js";function h(){return(0,g.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,g.jsxs)(a,{children:[(0,g.jsx)(m,{children:`Delete file?`}),(0,g.jsx)(u,{variant:`secondary`,children:`Close`})]}),(0,g.jsx)(p,{children:(0,g.jsx)(m,{children:`This action cannot be undone.`})}),(0,g.jsx)(s,{children:(0,g.jsxs)(d,{flexGrow:1,children:[(0,g.jsx)(u,{variant:`secondary`,children:`Cancel`}),(0,g.jsx)(u,{variant:`critical`,children:`Delete`})]})})]})}var g,_=t((()=>{f(),g=n()}));function v(){return(0,y.jsxs)(c,{children:[(0,y.jsx)(o,{children:`Name`}),(0,y.jsx)(l,{children:(0,y.jsx)(i,{placeholder:`Enter your name`})})]})}var y,b=t((()=>{f(),y=n()}));function x({contentGap:e=`md`,actionsJustify:t=`end`}){return(0,S.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,S.jsxs)(a,{children:[(0,S.jsx)(m,{children:`Delete file?`}),(0,S.jsx)(u,{variant:`secondary`,children:`Close`})]}),(0,S.jsxs)(p,{gap:e,children:[(0,S.jsx)(m,{children:`This action cannot be undone.`}),(0,S.jsx)(m,{children:`All associated data will be permanently removed.`})]}),(0,S.jsx)(s,{children:(0,S.jsxs)(d,{flexGrow:1,justifyContent:t,children:[(0,S.jsx)(u,{variant:`secondary`,children:`Cancel`}),(0,S.jsx)(u,{variant:`critical`,children:`Delete`})]})})]})}var S,C=t((()=>{f(),S=n()})),w=e({ButtonGroupProps:()=>A,ContentProps:()=>D,Default:()=>M,FooterProps:()=>k,Group:()=>N,GroupProps:()=>j,HeaderProps:()=>O,Playground:()=>P,__namedExportsOrder:()=>F,default:()=>E}),T,E,D,O,k,A,j,M,N,P,F,I=t((()=>{_(),b(),T=n(),C(),E={title:`components/Structure`},D={tags:[`!dev`],argTypes:{display:{name:`display`,description:`The display property for the flex container.`,type:{name:`other`,value:`'flex' | 'inline-flex'`,required:!1},table:{type:{summary:`'flex' | 'inline-flex'`},defaultValue:{summary:`'flex'`},category:`Layout`}},justifyContent:{name:`justifyContent`,description:`The distribution of space around children along the main axis in flex or inline axis in grid`,type:{name:`other`,value:`| 'normal'
    | 'start'
    | 'end'
    | 'center'
    | 'stretch'
...
object.`,type:{name:`other`,value:`string`,required:!1},table:{type:{summary:`string`},defaultValue:{summary:null},category:`Aria`}},size:{name:`size`,description:`Size for the controls inside the group.`,type:{name:`other`,value:`FieldSize`,required:!1},table:{type:{summary:`FieldSize`},defaultValue:{summary:`'md'`}}},className:{name:`className`,description:`The CSS [className](https://developer.mozilla.org/en-US/docs/Web/API/Element/className) for the
