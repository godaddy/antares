...
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:(0,x.jsx)(t.code,{children:`Group`})}),` — the boxed row for field controls (`,(0,x.jsx)(t.code,{children:`Input`}),`, `,(0,x.jsx)(t.code,{children:`TextArea`}),`, `,(0,x.jsx)(t.code,{children:`Button variant="control"`}),`). Layout defaults only; Field injects chrome via `,(0,x.jsx)(t.code,{children:`GroupContext`}),`. Size is `,(0,x.jsx)(t.code,{children:`size="sm" | "md"`}),`.`]}),`
`]}),`
...
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:`Adopted`}),` — placed inside a parent that provides its context (`,(0,x.jsx)(t.code,{children:`ContentContext`}),`, `,(0,x.jsx)(t.code,{children:`HeaderContext`}),`, `,(0,x.jsx)(t.code,{children:`FooterContext`}),`, `,(0,x.jsx)(t.code,{children:`ButtonGroupContext`}),`), it picks up that parent's styling and spacing automatically. Merge precedence is defaults < parent context < consumer props (`,(0,x.jsx)(t.code,{children:`className`}),` concatenates, handlers chain), via React Aria's `,(0,x.jsx)(t.code,{children:`useContextProps`}),`.`]}),`
`]}),`
`,(0,x.jsx)(t.p,{children:`A parent adopts them by providing the contexts around its children:`}),`
`,(0,x.jsx)(t.pre,{children:(0,x.jsx)(t.code,{className:`language-tsx`,children:`import { Provider } from 'react-aria-components';
