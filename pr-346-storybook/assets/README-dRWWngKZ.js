import{i as e}from"./preload-helper-BUun7Ttb.js";import{F as t}from"./iframe-Chq5peJP.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DZra4bZz.js";import{t as c}from"./mdx-react-shim-C-zo0mhg.js";import{t as l}from"./runtime-cfuOSczO.js";import{Actions as u,CardSelectionIndicatorProps as d,Checkbox as f,CornerActions as p,Default as m,Layout as h,Link as g,Media as _,Props as v,Radio as y,TextLockup as b,n as x,t as S}from"./card.stories-CF1KnUvG.js";function C(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(o,{of:S,name:`Overview`}),`
...
`,(0,T.jsxs)(t.li,{children:[`On a Card without a primary action or selection, `,(0,T.jsx)(t.code,{children:`aria-label`}),`, `,(0,T.jsx)(t.code,{children:`aria-labelledby`}),`, and
`,(0,T.jsx)(t.code,{children:`aria-describedby`}),` apply to the surface, for example with `,(0,T.jsx)(t.code,{children:`role="region"`}),`.`]}),`
...
CornerActions, buttons, inputs, selection, or other controls in an `,(0,T.jsx)(t.code,{children:`href`}),` Card. Clicking body text
on an `,(0,T.jsx)(t.code,{children:`onPress`}),` or selection Card activates it; dragging that text selects it.`]}),`
