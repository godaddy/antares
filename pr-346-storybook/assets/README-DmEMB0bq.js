import{i as e}from"./preload-helper-BUun7Ttb.js";import{F as t}from"./iframe-Cs7_B6MP.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-CM5A1gOC.js";import{t as c}from"./mdx-react-shim-3Ogmz4C4.js";import{t as l}from"./runtime-cfuOSczO.js";import{ButtonGroupProps as u,ContentProps as d,CornerActions as f,CornerActionsProps as p,Default as m,FooterProps as h,Group as g,GroupProps as _,HeaderProps as v,n as y,t as b}from"./structure.stories-CrnOfuir.js";function x(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(o,{of:y,name:`Overview`}),`
...
`,(0,C.jsxs)(t.li,{children:[(0,C.jsx)(t.strong,{children:(0,C.jsx)(t.code,{children:`ButtonGroup`})}),` — a cluster of related actions, typically inside a `,(0,C.jsx)(t.code,{children:`Footer`}),` (an end-aligned, wrapping row with `,(0,C.jsx)(t.code,{children:`role="group"`}),`).`]}),`
...
`,(0,C.jsxs)(t.p,{children:[(0,C.jsx)(t.code,{children:`Content`}),`, `,(0,C.jsx)(t.code,{children:`Header`}),`, `,(0,C.jsx)(t.code,{children:`Footer`}),`, and `,(0,C.jsx)(t.code,{children:`ButtonGroup`}),` each accept all `,(0,C.jsx)(t.code,{children:`Flex`}),` layout props.`]}),`
`,(0,C.jsx)(t.pre,{children:(0,C.jsx)(t.code,{className:`language-tsx`,children:`<Header>
  <Heading slot="title" />
  <CloseButton />
</Header>
<Content />
...
`,(0,C.jsxs)(t.p,{children:[(0,C.jsx)(t.code,{children:`CornerActions`}),` renders a plain `,(0,C.jsx)(t.code,{children:`<div>`}),` with no landmark role. It accepts the same layout props as
`,(0,C.jsx)(t.code,{children:`Flex`}),`, so consumers control placement, wrapping, and reserved space around the actions.`]}),`
