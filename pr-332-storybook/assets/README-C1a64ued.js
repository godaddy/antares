import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,l as a,n as o,s,u as c}from"./blocks-Cdu_Aq_A.js";import{a as l,c as u,d,f,i as p,l as m,n as h,o as g,r as _,s as v,t as y,u as b}from"./checkbox.stories-DmA86JXT.js";function x(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...r(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(s,{of:d,name:`Overview`}),`
...
`,(0,C.jsx)(i,{code:`import { Checkbox } from '@godaddy/antares';
...
`,(0,C.jsx)(t.p,{children:`Group multiple checkboxes together with a shared label.`}),`
`,(0,C.jsx)(a,{of:p,inline:!0}),`
`,(0,C.jsx)(i,{code:`import { Checkbox, CheckboxGroup, Group, Label } from '@godaddy/antares';
...
`,(0,C.jsx)(i,{code:`import { Checkbox, CheckboxGroup, Group, Label, Text } from '@godaddy/antares';
...
`,(0,C.jsx)(i,{code:`import { Checkbox, CheckboxGroup, FieldError, Group, Label, Text } from '@godaddy/antares';
...
`,(0,C.jsxs)(t.p,{children:[(0,C.jsx)(t.code,{children:`CheckboxGroup`}),` is composed: write `,(0,C.jsx)(t.code,{children:`Label`}),`, a `,(0,C.jsx)(t.code,{children:`Group`}),` holding the `,(0,C.jsx)(t.code,{children:`Checkbox`}),` items, `,(0,C.jsx)(t.code,{children:`Text slot="description"`}),`, and `,(0,C.jsx)(t.code,{children:`FieldError`}),`. The `,(0,C.jsx)(t.code,{children:`Group`}),` takes its axis, gap, and presentational role from the group's `,(0,C.jsx)(t.code,{children:`orientation`}),`, so a bare `,(0,C.jsx)(t.code,{children:`<Group>`}),` is all you need; pass your own `,(0,C.jsx)(t.code,{children:`direction`}),`/`,(0,C.jsx)(t.code,{children:`gap`}),` to lay the items out differently. Each `,(0,C.jsx)(t.code,{children:`Checkbox`}),` takes label text next to the indicator.`]}),`
...
`,(0,C.jsx)(t.pre,{children:(0,C.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup className="custom-checkbox-group">
...
`,(0,C.jsxs)(t.li,{children:[(0,C.jsx)(t.strong,{children:(0,C.jsx)(t.code,{children:`FieldError`})}),`: Displays validation error text below the group`]}),`
`]}),`
`,(0,C.jsx)(t.pre,{children:(0,C.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup isRequired isInvalid={!hasSelection}>
...
`,(0,C.jsxs)(t.p,{children:[`Use `,(0,C.jsx)(t.code,{children:`orientation="vertical"`}),` (default) to stack checkboxes, or `,(0,C.jsx)(t.code,{children:`orientation="horizontal"`}),` to arrange them in a row.`]}),`
...
`,(0,C.jsx)(t.pre,{children:(0,C.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup isRequired isInvalid={!agreedToTerms}>
...
`,(0,C.jsx)(t.pre,{children:(0,C.jsx)(t.code,{className:`language-tsx`,children:`<CheckboxGroup>
  <Label />
  <Group>
    <Checkbox />
  </Group>
...
`,(0,C.jsx)(o,{of:l})]})}function S(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,C.jsx)(t,{...e,children:(0,C.jsx)(x,{...e})}):x(e)}var C;function w(){return(w=e((()=>{C=t(),n(),c(),f()})))()}w();export{S as default};