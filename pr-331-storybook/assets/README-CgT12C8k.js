import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,i as a,l as o,n as s,s as c,u as l}from"./blocks-D20fQPfa.js";import{a as u,i as d,n as f,o as p,r as m,t as h}from"./icon.stories-DwW_UKky.js";var g;function _(){return(_=e((()=>{g=`import { Icon, set } from '@bento/icon';
/* v8 ignore next */
...
`})))()}var b;function x(){return(x=e((()=>{b=`import { Icon, ondemand } from '@bento/icon';
/* v8 ignore next */
import React, { type JSX } from 'react';
...
`})))()}function S(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...r(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(c,{of:u,name:`Overview`}),`
...
`})}),`
`,(0,w.jsx)(i,{language:`tsx`,code:b}),`
`,(0,w.jsx)(o,{of:f,inline:!0}),`
`,(0,w.jsx)(a,{of:f}),`
...
`})})]})}function C(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,w.jsx)(t,{...e,children:(0,w.jsx)(S,{...e})}):S(e)}var w;function T(){return(T=e((()=>{w=t(),n(),l(),p(),_(),y(),x()})))()}T();export{C as default};