import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,n as a,s as o,u as s}from"./blocks-D20fQPfa.js";import{i as c,n as l,r as u,t as d}from"./checkbox.stories-BCDkqzi9.js";var f;function p(){return(p=e((()=>{f=`/* v8 ignore next */
...
`})))()}var m;function h(){return(h=e((()=>{m=`/* v8 ignore next */
...
`})))()}var g;function _(){return(_=e((()=>{g=`/* v8 ignore next */
import type React from 'react';
...
`})))()}var v;function y(){return(y=e((()=>{v=`/* v8 ignore next */
import React, { useState } from 'react';
import { Checkbox, CheckboxGroup } from '@bento/checkbox';
import { Text } from '@bento/text';
...
`})))()}var b;function x(){return(x=e((()=>{b=`/* v8 ignore next */
import React, { useState } from 'react';
import { Checkbox, CheckboxGroup } from '@bento/checkbox';
import { Text } from '@bento/text';
...
`})))()}function S(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,...r(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(o,{of:u,name:`Overview`}),`
...
`,(0,w.jsx)(i,{language:`tsx`,code:f}),`
`,(0,w.jsx)(t.h3,{id:`checkbox-group`,children:`Checkbox Group`}),`
`,(0,w.jsxs)(t.p,{children:[`The `,(0,w.jsx)(t.code,{children:`CheckboxGroup`}),` allows a user to select multiple items from a list of `,(0,w.jsx)(t.code,{children:`Checkbox`}),` components.`]}),`
`,(0,w.jsx)(i,{language:`tsx`,code:g}),`
...
`,(0,w.jsx)(i,{language:`tsx`,code:b})]})}function C(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,w.jsx)(t,{...e,children:(0,w.jsx)(S,{...e})}):S(e)}var w;function T(){return(T=e((()=>{w=t(),n(),s(),c(),p(),h(),_(),y(),x()})))()}T();export{C as default};