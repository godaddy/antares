import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,n as a,s as o,u as s}from"./blocks-D20fQPfa.js";import{n as c,r as l,t as u}from"./overlay.stories-CGMx1ldy.js";var d;function f(){return(f=e((()=>{d=`/* v8 ignore next */
...
`})))()}var p;function m(){return(m=e((()=>{p=`/* v8 ignore next */
...
`})))()}var h;function g(){return(g=e((()=>{h=`/* v8 ignore next */
import React, { useState, useEffect } from 'react';
import { Overlay } from '@bento/overlay';
import { Portal } from '@bento/portal';
import { FocusLock } from '@bento/focus-lock';
...
`})))()}var _;function v(){return(v=e((()=>{_=`/* v8 ignore next */
...
`})))()}var y;function b(){return(b=e((()=>{y=`/* v8 ignore next */
...
`})))()}function x(e){let t={blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...r(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(o,{of:l,name:`Overview`}),`
...
mounting Portal, FocusLock, and other primitives when the overlay is closed.`})]})}function S(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,C.jsx)(t,{...e,children:(0,C.jsx)(x,{...e})}):x(e)}var C;function w(){return(w=e((()=>{C=t(),n(),s(),c(),f(),m(),g(),v(),b()})))()}w();export{S as default};