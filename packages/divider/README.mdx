...
##***REMOVED***Add your own styles with a `className`
...
##***REMOVED***Add your own styles with the `style` prop
...
##***REMOVED***Add your own styles by wrapping the `Divider` in another styled component
