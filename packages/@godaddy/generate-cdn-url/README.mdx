...
```typescript
// ❌ TypeScript error: Cannot mix packageName with pathSegments
...
Issues and pull requests are welcome at [https://github.com/godaddy/uxcore](https://github.com/godaddy/uxcore)
