...
canonical [Working with dates](?path=/docs/components-datefield--overview#working-with-dates)
section in the `DateField` docs for installation, locale handling, and common patterns.
