...
Pass `children` to compose `Label`, `Text`, `FieldError`, and item radios instead of the default group layout. Each `Radio` still takes label text next to the indicator.
