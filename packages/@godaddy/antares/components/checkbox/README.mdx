...
Pass `children` to compose `Label`, `Text`, `FieldError`, and item checkboxes instead of the default group layout. Each `Checkbox` still takes label text next to the indicator.
