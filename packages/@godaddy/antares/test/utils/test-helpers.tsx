...
export function preloadTestIcons() {
  set({
    ...
    ellipsis: (
      <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M6 13.25a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zm6 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zm6 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5z"
          fill="currentColor"
        />
      </svg>
    ),
    ...
    home: (
      <svg fill="none" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
        <path
          d="m22.43 9.636-10-7a.75.75 0 0 0-.86 0l-10 7a.75.75 0 0 0 .86 1.228l.82-.574v10.96A.75.75 0 0 0 4 22h16a.75.75 0 0 0 .75-.75V10.29l.82.574c.162.113.367.158.56.124s.371-.147.484-.308a.757.757 0 0 0 .124-.56.757.757 0 0 0-.308-.484zM9.75 20.5v-5.25A1.251 1.251 0 0 1 11 14h2a1.25 1.25 0 0 1 1.25 1.25v5.25zm9.5 0h-3.5v-5.25A2.753 2.753 0 0 0 13 12.5h-2a2.753 2.753 0 0 0-2.75 2.75v5.25h-3.5V9.24L12 4.166l7.25 5.074z"
          fill="currentColor"
        />
      </svg>
    ),
    'map-pin': (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g>
          <path d="M12 21.78a2.46 2.46 0 01-1.818-.808c-2.31-2.55-6.186-7.342-6.186-10.79A7.879 7.879 0 0112 2.28a7.879 7.879 0 018.004 7.902c0 3.448-3.875 8.24-6.186 10.79A2.46 2.46 0 0112 21.78zm0-18a6.394 6.394 0 00-6.504 6.402c0 2.15 2.113 5.716 5.797 9.783a.982.982 0 00.707.304.982.982 0 00.707-.304c3.684-4.067 5.797-7.632 5.797-9.783A6.394 6.394 0 0012 3.78z" />
          <path d="M12 13.168a2.883 2.883 0 11.001-5.767A2.883 2.883 0 0112 13.168zM12 8.9a1.383 1.383 0 100 2.767A1.383 1.383 0 0012 8.9z" />
        </g>
      </svg>
    ),
    x: (
