...
describe('@bento/use-svg-sprite', function useSvgSprite() {
  it('should render the standalone example', async function standaloneExample() {
    const { container } = await render(<BasicUsage />);
  ...
  it('should render the multiple icons example', async function multipleIconsExample() {
    const { container } = await render(<MultipleIcons />);
