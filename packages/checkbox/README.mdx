...
| `data-read-only` | Indicates the checkbox group is readonly | "true"         |
...
| `data-read-only`     | Indicates the checkbox is readonly            | "true"         |
| `data-required`      | Indicates the checkbox is required            | "true"         |
| `data-invalid`       | Indicates the checkbox is invalid             | "true"         |
| `data-indeterminate` | Indicates the checkbox is in indeterminate state | "true"      |
