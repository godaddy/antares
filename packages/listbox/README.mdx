...
##***REMOVED***When `items` prop is provided
...
##***REMOVED***When no `items` prop is provided  
...
##***REMOVED***Nested Collections with Sections
...
##***REMOVED***Styling with Data Attributes
...
###***REMOVED***ListBoxItem Attributes
...
###***REMOVED***Basic Slot Usage

<Source language='tsx' code={SlotsExample} />

###***REMOVED***Advanced Slot Patterns
...
##***REMOVED***Empty State Customization
...
##***REMOVED***Accessibility Customization
...
##***REMOVED***CSS-in-JS and Styled Components
...
##***REMOVED***Animation and Transitions
