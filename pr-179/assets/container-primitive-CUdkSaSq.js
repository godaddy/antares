...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Bento's edge"}),": Truly unstyled, minimal API, slot system, design system-agnostic."]})]})}function x(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{x as default};
