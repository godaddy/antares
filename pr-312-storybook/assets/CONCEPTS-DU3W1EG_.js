import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,l as a,n as o,s,u as c}from"./blocks-DHUUK51X.js";import{a as l,c as u,i as d,n as f,o as p,t as m}from"./slots.stories-B3EwLnie.js";import{n as h,t as g}from"./nested-DYuS_bAg.js";var _;function v(){return(v=e((()=>{_=`import { Nested } from './nested.tsx';
...
`})))()}var y;function b(){return(b=e((()=>{y=`import { Nested } from './nested.tsx';
...
`})))()}var x;function S(){return(S=e((()=>{x=`/* v8 ignore next */
...
`})))()}function C(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...r(),...e.components};return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(s,{of:u,name:`Concepts`}),`
...
`,(0,T.jsx)(i,{language:`tsx`,code:_}),`
`,(0,T.jsx)(a,{of:m,inline:!0}),`
...
`,(0,T.jsx)(i,{language:`tsx`,code:x}),`
`,(0,T.jsx)(t.p,{children:`The above example results in the following output:`}),`
`,(0,T.jsx)(a,{of:f,inline:!0})]})}function w(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,T.jsx)(t,{...e,children:(0,T.jsx)(C,{...e})}):C(e)}var T;function E(){return(E=e((()=>{T=t(),n(),c(),p(),v(),b(),g(),S()})))()}E();export{w as default};