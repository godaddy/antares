...
`})))()}var v;function y(){return(y=e((()=>{v=`import { parser } from '@bento/svg-parser';
...
`})))()}var b;function x(){return(x=e((()=>{b=`import { parser } from '@bento/svg-parser';
...
`})))()}var S;function C(){return(C=e((()=>{S=`import { parser } from '@bento/svg-parser';
...
`})))()}function w(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,...r(),...e.components};return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(s,{of:m,name:`Overview`}),`
...
`,(0,E.jsx)(a,{of:d})]})}function T(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,E.jsx)(t,{...e,children:(0,E.jsx)(w,{...e})}):w(e)}var E;function D(){return(D=e((()=>{E=t(),n(),c(),l(),_(),y(),x(),C()})))()}D();export{T as default};