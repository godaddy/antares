import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,n as a,s as o,u as s}from"./blocks-DHUUK51X.js";import{n as c,r as l,t as u}from"./text.stories-OIn56mGD.js";var d;function f(){return(f=e((()=>{d=`import { Text, type TextProps } from '@bento/text';
/* v8 ignore next */
...
`})))()}var p;function m(){return(m=e((()=>{p=`import { Text, type TextProps } from '@bento/text';
/* v8 ignore next */
import React from 'react';
...
`})))()}var h;function g(){return(g=e((()=>{h=`import { Text, type TextProps } from '@bento/text';
/* v8 ignore next */
import React from 'react';
...
`})))()}var _;function v(){return(v=e((()=>{_=`import { Text, type TextProps } from '@bento/text';
/* v8 ignore next */
import React from 'react';
...
`})))()}var y;function b(){return(b=e((()=>{y=`import { Text, type TextProps } from '@bento/text';
/* v8 ignore next */
import React from 'react';
...
`})))()}function x(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...r(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(o,{of:l,name:`Overview`}),`
...
`]}),`
`,(0,C.jsx)(i,{language:`tsx`,code:y})]})}function S(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,C.jsx)(t,{...e,children:(0,C.jsx)(x,{...e})}):x(e)}var C;function w(){return(w=e((()=>{C=t(),n(),s(),c(),f(),m(),g(),v(),b()})))()}w();export{S as default};