import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,n as a,s as o,u as s}from"./blocks-DHUUK51X.js";import{n as c,r as l,t as u}from"./portal.stories-B7gt28aH.js";var d;function f(){return(f=e((()=>{d=`import { Portal } from '@bento/portal';
...
`})))()}var p;function m(){return(m=e((()=>{p=`import { Portal } from '@bento/portal';
import { Container } from '@bento/container';
import { Text } from '@bento/text';
/* v8 ignore next */
...
`})))()}var h;function g(){return(g=e((()=>{h=`import { Portal } from '@bento/portal';
import { Container } from '@bento/container';
import { Text } from '@bento/text';
...
`})))()}function _(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...r(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(o,{of:l,name:`Overview`}),`
