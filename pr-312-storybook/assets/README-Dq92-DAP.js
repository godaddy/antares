import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,n as a,s as o,u as s}from"./blocks-DHUUK51X.js";import{n as c,r as l,t as u}from"./pressable.stories-DED_QWpQ.js";var d;function f(){return(f=e((()=>{d=`import { Pressable } from '@bento/pressable';
/* v8 ignore next */
...
`})))()}var p;function m(){return(m=e((()=>{p=`import { Pressable } from '@bento/pressable';
/* v8 ignore next */
import React from 'react';
...
`})))()}var h;function g(){return(g=e((()=>{h=`import { Pressable } from '@bento/pressable';
/* v8 ignore next */
import React from 'react';
...
`})))()}function _(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...r(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(o,{of:l,name:`Overview`}),`
...
`})})]})}function v(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,y.jsx)(t,{...e,children:(0,y.jsx)(_,{...e})}):_(e)}var y;function b(){return(b=e((()=>{y=t(),n(),s(),c(),f(),m(),g()})))()}b();export{v as default};