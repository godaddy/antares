import{i as e}from"./preload-helper-D5h1UUhK.js";import{y as t}from"./iframe-yltz23TO.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-gd5tRDoH.js";import{t as c}from"./mdx-react-shim-C11mQOSS.js";import{Default as l,Disabled as u,DropTargetLabel as d,FileUpload as f,Props as p,ReplaceFile as m,n as h,t as g}from"./drop-zone.stories-Ch35288K.js";var _,v=e((()=>{_=`import { DropZone, isFileDropItem, Text } from '@godaddy/antares';
...
`}));function D(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(o,{of:g,name:`Overview`}),`
...
`,(0,k.jsxs)(t.p,{children:[`A reference showing how to compose `,(0,k.jsx)(t.code,{children:`DropZone`}),` with other Antares components to build a functional file upload experience. Use this as a starting point — adapt the accepted formats, size limit, and handlers to your product's requirements.`]}),`
`,(0,k.jsx)(t.p,{children:`It demonstrates the two common upload affordances working together:`}),`
`,(0,k.jsxs)(t.ul,{children:[`
`,(0,k.jsxs)(t.li,{children:[(0,k.jsx)(t.strong,{children:`Click to browse`}),` — the "Add files" button opens the native file picker and returns the selection through `,(0,k.jsx)(t.code,{children:`onSelect`}),`. `,(0,k.jsx)(t.code,{children:`acceptedFileTypes`}),` restricts the picker to the supported formats.`]}),`
`,(0,k.jsxs)(t.li,{children:[(0,k.jsx)(t.strong,{children:`Drag and drop`}),` — `,(0,k.jsx)(t.code,{children:`getDropOperation`}),` inspects the dragged types and returns `,(0,k.jsx)(t.code,{children:`'cancel'`}),` for unsupported files so the zone won't accept them, while `,(0,k.jsx)(t.code,{children:`onDrop`}),` reads the dropped files with the `,(0,k.jsx)(t.code,{children:`isFileDropItem`}),` guard.`]}),`
`]}),`
`,(0,k.jsxs)(t.p,{children:[`Both paths funnel into one handler that renders a preview. `,(0,k.jsx)(t.code,{children:`acceptedFileTypes`}),` and `,(0,k.jsx)(t.code,{children:`getDropOperation`}),` are best-effort UX filters — validate file type and size again in your handler, since they can be bypassed.`]}),`
`,(0,k.jsxs)(t.p,{children:[`When the drop zone content is composed from multiple elements (icon, button, text), pass `,(0,k.jsx)(t.code,{children:`aria-label`}),` directly on `,(0,k.jsx)(t.code,{children:`DropZone`}),` to provide a single accessible name for the hidden drop button.`]}),`
`,(0,k.jsx)(i,{of:f,inline:!0}),`
`,(0,k.jsx)(r,{language:`tsx`,code:x}),`
`,(0,k.jsx)(t.h3,{id:`drop-target-label`,children:`Drop Target Label`}),`
`,(0,k.jsxs)(t.p,{children:[`Pass a render-prop function as `,(0,k.jsx)(t.code,{children:`children`}),` to change the zone's content while a valid drag is active. RAC invokes it with `,(0,k.jsx)(t.a,{href:`https://react-spectrum.adobe.com/react-aria/DropZone.html#dropzonerenderprops`,rel:`nofollow`,children:(0,k.jsx)(t.code,{children:`DropZoneRenderProps`})}),` on every state transition, so branching on `,(0,k.jsx)(t.code,{children:`isDropTarget`}),` requires no extra state. Pair it with `,(0,k.jsx)(t.code,{children:`getDropOperation`}),` to reject unsupported types — the label only appears when the drag is actually accepted.`]}),`
`,(0,k.jsx)(i,{of:d,inline:!0}),`
`,(0,k.jsx)(r,{language:`tsx`,code:C}),`
`,(0,k.jsx)(t.h3,{id:`replace-existing-file`,children:`Replace Existing File`}),`
`,(0,k.jsxs)(t.p,{children:[`Demonstrates the `,(0,k.jsx)(t.code,{children:`isFilled`}),` pattern: when the zone already holds a file, dragging a new valid file over it shows a "Drop to replace" label while the container switches to its active teal state. The drag path and the click path (`,(0,k.jsx)(t.code,{children:`FileTrigger`}),`) share the same handler, so both replace the current selection.`]}),`
`,(0,k.jsxs)(t.p,{children:[(0,k.jsx)(t.code,{children:`isFilled`}),` is not a built-in prop — derive it from your own state so your product controls when the zone is considered occupied and when it resets.`]}),`
