...
Baselines are **Linux** PNGs generated by the `/update-screenshots` CI bot after the PR opens. Visual tests run on CI by default; run them locally only to inspect.
