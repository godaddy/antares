import{a as e,i as t}from"./preload-helper-HTw_Lvtv.js";import{F as n}from"./iframe-l2wWW_Ox.js";import{t as r}from"./src-CnhOM4lg.js";import{Ht as i,Jt as a,Kt as o,Wt as s,en as c,t as l}from"./antares-Fmxi4S7f.js";import{i as u}from"./src-O4MsJswD.js";function d(){return(0,f.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,f.jsxs)(o,{children:[(0,f.jsx)(u,{children:`Delete file?`}),(0,f.jsx)(c,{variant:`secondary`,children:`Close`})]}),(0,f.jsx)(a,{children:(0,f.jsx)(u,{children:`This action cannot be undone.`})}),(0,f.jsx)(s,{children:(0,f.jsxs)(i,{flexGrow:1,children:[(0,f.jsx)(c,{variant:`secondary`,children:`Cancel`}),(0,f.jsx)(c,{variant:`critical`,children:`Delete`})]})})]})}var f,p=t((()=>{l(),f=n()}));function m({contentGap:e=`md`,actionsJustify:t=`end`}){return(0,h.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,h.jsxs)(o,{children:[(0,h.jsx)(u,{children:`Delete file?`}),(0,h.jsx)(c,{variant:`secondary`,children:`Close`})]}),(0,h.jsxs)(a,{gap:e,children:[(0,h.jsx)(u,{children:`This action cannot be undone.`}),(0,h.jsx)(u,{children:`All associated data will be permanently removed.`})]}),(0,h.jsx)(s,{children:(0,h.jsxs)(i,{flexGrow:1,justifyContent:t,children:[(0,h.jsx)(c,{variant:`secondary`,children:`Cancel`}),(0,h.jsx)(c,{variant:`critical`,children:`Delete`})]})})]})}var h,g=t((()=>{l(),h=n()})),_=e({ButtonGroupProps:()=>C,ContentProps:()=>b,Default:()=>w,FooterProps:()=>S,HeaderProps:()=>x,Playground:()=>T,__namedExportsOrder:()=>E,default:()=>y}),v,y,b,x,S,C,w,T,E,D=t((()=>{p(),v=n(),g(),y={title:`components/Structure`},b={tags:[`!dev`],argTypes:{display:{name:`display`,description:`The display property for the flex container.`,type:{name:`other`,value:`'flex' | 'inline-flex'`,required:!1},table:{type:{summary:`'flex' | 'inline-flex'`},defaultValue:{summary:`'flex'`},category:`Layout`}},justifyContent:{name:`justifyContent`,description:`The distribution of space around children along the main axis in flex or inline axis in grid`,type:{name:`other`,value:`| 'normal'
    | 'start'
    | 'end'
    | 'center'
    | 'stretch'
