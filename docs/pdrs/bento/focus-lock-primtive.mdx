...
<Meta title="Bento/Architecture/PDRs/Focus Lock" />

# Focus Lock Primitive PDR
...
## Custom Focus Behavior with Render Props
...
### Hook Usage for Advanced Control
...
### Form Section with Focus Management
