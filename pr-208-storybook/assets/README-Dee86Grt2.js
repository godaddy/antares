import{i as e}from"./preload-helper-usAeo7Bx.js";import{y as t}from"./iframe-BI6CrVrR.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DR_nPsI2.js";import{t as c}from"./mdx-react-shim-B5mzwAp5.js";import{Default as l,Emphases as u,HighContrast as d,Icons as f,Indicator as p,Props as m,Sizes as h,n as g,t as _}from"./tag.stories-DHYmlcvU.js";var v,y=e((()=>{v=`import { Tag, type TagProps } from '@godaddy/antares';
...
`})),E,D=e((()=>{E=`import { Flex, Icon, Tag } from '@godaddy/antares';
...
`}));function A(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{of:g,name:`Overview`}),`
...
`,(0,M.jsxs)(t.p,{children:[`Icons reinforce the tag's meaning at a glance. Add an `,(0,M.jsx)(t.code,{children:`Icon`}),` as a child — it inherits the tag's color and scales with its size.`]}),`
...
`,(0,M.jsxs)(t.p,{children:[`The `,(0,M.jsx)(t.code,{children:`design`}),` prop controls the visual treatment:`]}),`
`,(0,M.jsxs)(t.table,{children:[(0,M.jsx)(t.thead,{children:(0,M.jsxs)(t.tr,{children:[(0,M.jsx)(t.th,{children:(0,M.jsx)(t.code,{children:`design`})}),(0,M.jsx)(t.th,{children:`What it looks like`}),(0,M.jsx)(t.th,{children:`Best for`})]})}),(0,M.jsxs)(t.tbody,{children:[(0,M.jsxs)(t.tr,{children:[(0,M.jsx)(t.td,{children:(0,M.jsx)(t.code,{children:`filled`})}),(0,M.jsx)(t.td,{children:`Colored background with contrasting text`}),(0,M.jsx)(t.td,{children:`Most use cases`})]}),(0,M.jsxs)(t.tr,{children:[(0,M.jsx)(t.td,{children:(0,M.jsx)(t.code,{children:`inline`})}),(0,M.jsx)(t.td,{children:`Text only, no background or border`}),(0,M.jsx)(t.td,{children:`Inside paragraphs or sentences`})]})]})]}),`
`,(0,M.jsxs)(t.blockquote,{children:[`
`,(0,M.jsxs)(t.p,{children:[(0,M.jsx)(t.strong,{children:`Indicator`}),` is a separate boolean prop (`,(0,M.jsx)(t.code,{children:`indicator={true}`}),`), not a `,(0,M.jsx)(t.code,{children:`design`}),` value. It renders a colored dot on a plain background and forces high-contrast colors — useful in tables and data-heavy views. See the `,(0,M.jsx)(t.a,{href:`#indicator`,children:`Indicator`}),` example above.`]}),`
`]}),`
