import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{N as n,P as r,c as i,s as a,u as o}from"./blocks-DWAlwQ0B.js";import{n as s,t as c}from"./forward.stories-CK1ZmK-P.js";var l;function u(){return(u=e((()=>{l=`import { withForwardRef } from '@bento/forward';
/* v8 ignore next */
...
`})))()}var d;function f(){return(f=e((()=>{d=`import { withForwardRef } from '@bento/forward';
/* v8 ignore next */
...
`})))()}var p;function m(){return(m=e((()=>{p=`import { withForwardRef } from '@bento/forward';
/* v8 ignore next */
import type React from 'react';
...
`})))()}var h;function g(){return(g=e((()=>{h=`import { withForwardRef } from '@bento/forward';
/* v8 ignore next */
import type React from 'react';
...
`})))()}function _(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...r(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(a,{of:c,name:`Overview`}),`
...
`]})]})}function v(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,y.jsx)(t,{...e,children:(0,y.jsx)(_,{...e})}):_(e)}var y;function b(){return(b=e((()=>{y=t(),n(),o(),s(),u(),f(),m(),g()})))()}b();export{v as default};