import{i as e}from"./preload-helper-DJJpItO4.js";import{F as t}from"./iframe-DZMP6bXg.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-8ulixqEt.js";import{t as c}from"./mdx-react-shim-vsrhSS13.js";import{t as l}from"./runtime-CA9nCnLu.js";import{Composed as u,ComposedRange as d,Controlled as f,DateRangePickerProps as p,Default as m,Disabled as h,FormatOptions as g,MinMax as _,Props as v,Range as y,WithError as b,n as x,t as S}from"./date-picker.stories-mUW3chgW.js";function C(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(o,{of:S,name:`Overview`}),`
...
`,(0,T.jsxs)(t.li,{children:[(0,T.jsx)(t.strong,{children:`Composable interior`}),`: Compose `,(0,T.jsx)(t.code,{children:`Label`}),`, a `,(0,T.jsx)(t.code,{children:`Button slot="trigger"`}),`, `,(0,T.jsx)(t.code,{children:`DatePickerCalendar`}),`, and optional `,(0,T.jsx)(t.code,{children:`Text`}),` / `,(0,T.jsx)(t.code,{children:`FieldError`}),`. Nothing is added for you, and what you write keeps the order you wrote it in. `,(0,T.jsx)(t.code,{children:`children`}),` also accepts a function for picker state`]}),`
`,(0,T.jsxs)(t.li,{children:[(0,T.jsx)(t.strong,{children:`Trigger and calendar`}),`: An empty `,(0,T.jsx)(t.code,{children:`Button slot="trigger"`}),` renders a calendar icon and the formatted value from the field. `,(0,T.jsx)(t.code,{children:`DatePickerCalendar`}),` (and `,(0,T.jsx)(t.code,{children:`DateRangePickerCalendar`}),`) is the calendar in the popover it opens: it takes `,(0,T.jsx)(t.code,{children:`Calendar`}),` props plus `,(0,T.jsx)(t.code,{children:`popoverProps`}),` for the overlay. Write `,(0,T.jsx)(t.code,{children:`Popover`}),`, `,(0,T.jsx)(t.code,{children:`Content`}),`, and `,(0,T.jsx)(t.code,{children:`Calendar`}),` yourself to replace the whole overlay`]}),`
...
`,(0,T.jsxs)(t.li,{children:[`Label formatting via `,(0,T.jsx)(t.code,{children:`formatOptions`}),` / `,(0,T.jsx)(t.code,{children:`placeholder`}),` on the picker itself, or on `,(0,T.jsx)(t.code,{children:`DatePickerValue`}),` / `,(0,T.jsx)(t.code,{children:`DateRangePickerValue`}),` in a trigger you write`]}),`
...
`,(0,T.jsx)(r,{code:`import { Button, DatePicker, DatePickerCalendar, Label } from '@godaddy/antares';
...
`,(0,T.jsx)(r,{code:`import { Button, DateRangePicker, DateRangePickerCalendar, Label } from '@godaddy/antares';
...
`,(0,T.jsxs)(t.p,{children:[`Controlling the trigger's label format via `,(0,T.jsx)(t.code,{children:`formatOptions`}),`.`]}),`
...
`,(0,T.jsx)(r,{code:`import { Button, DatePicker, DatePickerCalendar, FieldError, Label } from '@godaddy/antares';
...
`,(0,T.jsxs)(t.p,{children:[`Write the trigger and the overlay yourself instead of composing `,(0,T.jsx)(t.code,{children:`DatePickerCalendar`}),`, for full
control over the popover and the calendar.`]}),`
`,(0,T.jsx)(i,{of:u,inline:!0}),`
`,(0,T.jsx)(r,{code:`import { Button, Calendar, Content, DatePicker, DatePickerValue, Icon, Label, Popover, Text } from '@godaddy/antares';
import { parseDate } from '@godaddy/antares/date';
...
`,(0,T.jsx)(t.p,{children:`Write a DateRangePicker's trigger and overlay from lower-level pieces the same way.`}),`
...
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-tsx`,children:`<DatePicker>
  <Label />
  <Group>
    <Button slot="trigger">
      <DatePickerValue />
...
`})}),`
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-tsx`,children:`<DateRangePicker>
  <Label />
  <Group>
    <Button slot="trigger">
      <DateRangePickerValue />
