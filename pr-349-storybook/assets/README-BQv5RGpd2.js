import{i as e}from"./preload-helper-CWTa06Vb.js";import{F as t}from"./iframe-grKlm5Vr.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-CLwCUoGU.js";import{t as c}from"./mdx-react-shim-DQfI3Oql.js";import{t as l}from"./runtime-Bn9Cmkgz.js";import{Controlled as u,Default as d,Disabled as f,FormSteps as p,Multiple as m,Nested as h,Props as g,n as _,t as v}from"./accordion.stories-CeHWJcEV.js";function y(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(o,{of:v,name:`Overview`}),`
...
`,(0,x.jsxs)(t.table,{children:[(0,x.jsx)(t.thead,{children:(0,x.jsxs)(t.tr,{children:[(0,x.jsx)(t.th,{children:`Key`}),(0,x.jsx)(t.th,{children:`Action`})]})}),(0,x.jsxs)(t.tbody,{children:[(0,x.jsxs)(t.tr,{children:[(0,x.jsxs)(t.td,{children:[(0,x.jsx)(t.code,{children:`Tab`}),` / `,(0,x.jsx)(t.code,{children:`Shift + Tab`})]}),(0,x.jsx)(t.td,{children:`Move between enabled triggers and controls in expanded panels`})]}),(0,x.jsxs)(t.tr,{children:[(0,x.jsxs)(t.td,{children:[(0,x.jsx)(t.code,{children:`Enter`}),` / `,(0,x.jsx)(t.code,{children:`Space`})]}),(0,x.jsx)(t.td,{children:`Toggle the focused section; focus stays on the trigger`})]})]})]}),`
`,(0,x.jsx)(t.h3,{id:`aria`,children:`ARIA`}),`
`,(0,x.jsxs)(t.ul,{children:[`
`,(0,x.jsxs)(t.li,{children:[`Each section's trigger is a native button with `,(0,x.jsx)(t.code,{children:`aria-expanded`}),` and `,(0,x.jsx)(t.code,{children:`aria-controls`}),` linked to its panel.`]}),`
`,(0,x.jsxs)(t.li,{children:[`Each panel is labeled by its trigger through `,(0,x.jsx)(t.code,{children:`aria-labelledby`}),` automatically.`]}),`
`]}),`
...
`,(0,x.jsx)(t.li,{children:`Use descriptive section titles and heading levels that fit the page hierarchy.`}),`
