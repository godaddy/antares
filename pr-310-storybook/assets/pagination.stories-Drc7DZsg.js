import{a as e,i as t,s as n}from"./preload-helper-DlXxGc_m.js";import{V as r,y as i}from"./iframe-C1R0NnmS.js";import{t as a}from"./src-taHnAqtT.js";import{H as o,t as s}from"./antares-BIpu9FKX.js";function c(){let[e,t]=(0,l.useState)(0);return(0,u.jsxs)(a,{direction:`column`,gap:`sm`,children:[(0,u.jsx)(o,{total:5,onChange:t}),(0,u.jsxs)(a,{as:`span`,justifyContent:`center`,children:[`Current page: `,e]})]})}var l,u,d=t((()=>{s(),l=n(r(),1),u=i()}));function f(){let[e,t]=(0,p.useState)(2);return(0,m.jsxs)(a,{direction:`column`,gap:`sm`,children:[(0,m.jsx)(o,{total:4,activeIndex:e,onChange:t}),(0,m.jsxs)(a,{as:`span`,justifyContent:`center`,children:[`Current page: `,e]})]})}var p,m,h=t((()=>{s(),p=n(r(),1),m=i()}));function g(){return(0,_.jsx)(o,{total:5,defaultActiveIndex:2})}var _,v=t((()=>{s(),_=i()}));function y(){return(0,b.jsx)(o,{total:10,limit:3})}var b,x=t((()=>{s(),b=i()}));function S(){let[e,t]=(0,C.useState)(void 0);return(0,w.jsxs)(a,{direction:`column`,gap:`sm`,children:[(0,w.jsx)(o,{total:3,onChange:t}),(0,w.jsxs)(a,{as:`span`,justifyContent:`center`,children:[`onChange: `,e??`none`]})]})}var C,w,T=t((()=>{s(),C=n(r(),1),w=i()}));function E({total:e=10,variant:t=`dots`,hideControls:n=!1,limit:r=1}){return(0,D.jsx)(o,{total:e,variant:t===`none`?null:t,hideControls:n,limit:r})}var D,O=t((()=>{s(),D=i()})),k=e({Controlled:()=>P,Default:()=>N,DefaultActive:()=>F,OnChange:()=>L,Playground:()=>R,Props:()=>M,WithLimit:()=>I,__namedExportsOrder:()=>z,default:()=>j}),A,j,M,N,P,F,I,L,R,z,B=t((()=>{d(),h(),v(),x(),T(),A=i(),O(),j={title:`components/Pagination`},M={tags:[`!dev`],argTypes:{onChange:{name:`onChange`,description:`Called when the active page changes.`,type:{name:`other`,value:`(index: number) => void`,required:!1},table:{type:{summary:`(index: number) => void`},defaultValue:{summary:null},category:`Events`}},display:{name:`display`,description:`The display property for the flex container.`,type:{name:`other`,value:`'flex' | 'inline-flex'`,required:!1},table:{type:{summary:`'flex' | 'inline-flex'`},defaultValue:{summary:`'flex'`},category:`Layout`}},justifyContent:{name:`justifyContent`,description:`The distribution of space around children along the main axis in flex or inline axis in grid`,type:{name:`other`,value:`| 'normal'
    | 'start'
    | 'end'
    | 'center'
    | 'stretch'
