import{i as e}from"./preload-helper-r38FjZtB.js";import{y as t}from"./iframe-B_kZb_nK.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DM1WPZlj.js";import{t as c}from"./mdx-react-shim-CHlMYpzY.js";import{Basic as l,IconAccessories as u,LeadingControl as d,Props as f,TrailingControl as p,n as m,t as h}from"./field.stories-DPI0HcyT.js";var g,_=e((()=>{g=`import {
  Field,
  FieldButton,
  FieldDescription,
  FieldGroup,
...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldInput`})}),` — the single-line control the user types into (a normalized React Aria `,(0,w.jsx)(t.code,{children:`Input`}),` given antares spacing via `,(0,w.jsx)(t.code,{children:`Box`}),`).`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldTextArea`})}),` — the multiline control the user types into (a normalized React Aria `,(0,w.jsx)(t.code,{children:`TextArea`}),` given antares spacing via `,(0,w.jsx)(t.code,{children:`Box`}),`).`]}),`
...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldTrigger`})}),` — a full-width value-display button inside the box that opens an overlay (used by Select and DatePicker): a value area plus a trailing icon, laid out across the group. `,(0,w.jsx)(t.code,{children:`variant="select"`}),` is transparent and input-like; `,(0,w.jsx)(t.code,{children:`variant="control"`}),` is a filled segment inside a shared group.`]}),`
