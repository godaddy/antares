import{i as e}from"./preload-helper-DOotEt7k.js";import{y as t}from"./iframe-CdiC1iam.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DpQ4n8sJ.js";import{t as c}from"./mdx-react-shim-CS7Sz8tJ.js";import{Default as l,Disabled as u,MinMax as d,Props as f,Range as p,RangeCalendarProps as m,Unavailable as h,WithValue as g,n as _,t as v}from"./calendar.stories-KqSzJc3W.js";var y,b=e((()=>{y=`import { Calendar } from '@godaddy/antares';
...
`}));function j(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(o,{of:v,name:`Overview`}),`
...
`,(0,N.jsxs)(t.p,{children:[(0,N.jsx)(t.code,{children:`Calendar`}),` values are `,(0,N.jsx)(t.code,{children:`CalendarDate`}),` objects. Import the date primitives you need from the `,(0,N.jsx)(t.code,{children:`@godaddy/antares/date`}),` subpath:`]}),`
`,(0,N.jsx)(t.pre,{children:(0,N.jsx)(t.code,{className:`language-tsx`,children:`import { parseDate, today, getLocalTimeZone } from '@godaddy/antares/date';
...
`})}),`
`,(0,N.jsxs)(t.p,{children:[(0,N.jsx)(t.code,{children:`@godaddy/antares/date`}),` re-exports `,(0,N.jsx)(t.a,{href:`https://react-spectrum.adobe.com/internationalized/date/`,rel:`nofollow`,children:(0,N.jsx)(t.code,{children:`@internationalized/date`})}),`, the package behind these date primitives.`]}),`
