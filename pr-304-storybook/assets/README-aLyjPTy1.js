...
`})))()}var v;function y(){return(y=e((()=>{v=`import { Button, Menu, MenuItem, MenuSeparator, MenuTrigger, SubmenuTrigger } from '@godaddy/antares';
...
`})))()}var b;function x(){return(x=e((()=>{b=`import { Button, Menu, MenuItem, MenuSeparator, MenuTrigger } from '@godaddy/antares';
...
`})))()}var S;function C(){return(C=e((()=>{S=`import { Button, Menu, MenuHeader, MenuItem, MenuSection, MenuSeparator, MenuTrigger } from '@godaddy/antares';
...
`})))()}function w(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...r(),...e.components};return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(s,{of:m,name:`Overview`}),`
...
`})})]})}function T(e={}){let{wrapper:t}={...r(),...e.components};return t?(0,E.jsx)(t,{...e,children:(0,E.jsx)(w,{...e})}):w(e)}var E;function D(){return(D=e((()=>{E=t(),n(),c(),_(),y(),x(),C(),f()})))()}D();export{T as default};