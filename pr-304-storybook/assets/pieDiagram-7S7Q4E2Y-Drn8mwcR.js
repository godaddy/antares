import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,r as n}from"./mermaid-parser.core-DXCYrBSM.js";import{n as r,r as i}from"./chunk-Y2CYZVJY-C0ErJKbO.js";import{a,i as o,t as s}from"./src-Bn7DK4KF.js";import{U as c,W as l,a as u,c as d,f,j as p,q as m,v as h,w as g,x as _,y as v}from"./chunk-I66GZJ75-B0L0Y-Td.js";import{n as y}from"./ordinal-qriLbjob.js";import{t as b}from"./arc-lqCpB7PJ.js";import{n as x}from"./pie-DLYrvLpu.js";import{d as S,i as C,m as w}from"./chunk-NSK5VX7P-Dd2Ey8sD.js";import{n as T,t as E}from"./chunk-JWPE2WC7-fSzem9U5.js";import{l as D,u as O}from"./mermaid.core-B-rAa8sZ.js";var k,A,j,M,N,P,F,I,L,R,z;function B(){return(B=e((()=>{E(),D(),S(),p(),o(),i(),t(),s(),k=f.pie,A={sections:new Map,showData:!1,config:k},j=A.sections,M=A.showData,N=structuredClone(k),P={getConfig:r(()=>structuredClone(N),`getConfig`),clear:r(()=>{j=new Map,M=A.showData,u()},`clear`),setDiagramTitle:m,getDiagramTitle:g,setAccTitle:l,getAccTitle:v,setAccDescription:c,getAccDescription:h,addSection:r(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);j.has(e)||(j.set(e,t),a.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:r(()=>j,`getSections`),setShowData:r(e=>{M=e},`setShowData`),getShowData:r(()=>M,`getShowData`)},F=r((e,t)=>{T(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),I={parse:r(async e=>{let t=await n(`pie`,e);a.debug(t),F(t,P)},`parse`)},L=r(e=>`
  .pieCircle{
