import{a as e,i as t}from"./preload-helper-Bb7i_SVf.js";import{y as n}from"./iframe-B2TvfXAj.js";import{t as r}from"./src-6akdiAcS.js";import{$t as i,Gt as a,Ut as o,Vt as s,qt as c,t as l}from"./antares-BfpQhRFU.js";import{t as u}from"./src-BkRI40Xe.js";function d(){return(0,f.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,f.jsxs)(a,{children:[(0,f.jsx)(u,{children:`Delete file?`}),(0,f.jsx)(i,{variant:`secondary`,children:`Close`})]}),(0,f.jsx)(c,{children:(0,f.jsx)(u,{children:`This action cannot be undone.`})}),(0,f.jsx)(o,{children:(0,f.jsxs)(s,{flexGrow:1,children:[(0,f.jsx)(i,{variant:`secondary`,children:`Cancel`}),(0,f.jsx)(i,{variant:`critical`,children:`Delete`})]})})]})}var f,p=t((()=>{l(),f=n()}));function m({contentGap:e=`md`,actionsJustify:t=`end`}){return(0,h.jsxs)(r,{direction:`column`,gap:`md`,padding:`md`,style:{border:`1px solid var(--ux-gray-300, #ccc)`,borderRadius:8},children:[(0,h.jsxs)(a,{children:[(0,h.jsx)(u,{children:`Delete file?`}),(0,h.jsx)(i,{variant:`secondary`,children:`Close`})]}),(0,h.jsxs)(c,{gap:e,children:[(0,h.jsx)(u,{children:`This action cannot be undone.`}),(0,h.jsx)(u,{children:`All associated data will be permanently removed.`})]}),(0,h.jsx)(o,{children:(0,h.jsxs)(s,{flexGrow:1,justifyContent:t,children:[(0,h.jsx)(i,{variant:`secondary`,children:`Cancel`}),(0,h.jsx)(i,{variant:`critical`,children:`Delete`})]})})]})}var h,g=t((()=>{l(),h=n()})),_=e({ButtonGroupProps:()=>C,ContentProps:()=>b,Default:()=>w,FooterProps:()=>S,HeaderProps:()=>x,Playground:()=>T,__namedExportsOrder:()=>E,default:()=>y}),v,y,b,x,S,C,w,T,E,D=t((()=>{p(),v=n(),g(),y={title:`components/Structure`},b={tags:[`!dev`],argTypes:{display:{name:`display`,description:`The display property for the flex container.`,type:{name:`other`,value:`'flex' | 'inline-flex'`,required:!1},table:{type:{summary:`'flex' | 'inline-flex'`},defaultValue:{summary:`'flex'`},category:`Layout`}},justifyContent:{name:`justifyContent`,description:`The distribution of space around children along the main axis in flex or inline axis in grid`,type:{name:`other`,value:`| 'normal'
    | 'start'
    | 'end'
    | 'center'
    | 'stretch'
