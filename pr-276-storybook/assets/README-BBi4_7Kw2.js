import{i as e}from"./preload-helper-DvdRENtr.js";import{y as t}from"./iframe-DhuG6jpW.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-D8d9ding.js";import{t as c}from"./mdx-react-shim-BOtSxo7g.js";import{Controlled as l,Default as u,Disabled as d,Form as f,Labels as p,Markers as m,Props as h,n as g,t as _}from"./range-slider.stories-DAIHSH3k.js";var v,y=e((()=>{v=`import { RangeSlider } from '@godaddy/antares';
...
`,(0,M.jsxs)(t.li,{children:[`Independent `,(0,M.jsx)(t.code,{children:`startName`}),` and `,(0,M.jsx)(t.code,{children:`endName`}),` values for native form submission`]}),`
...
`,(0,M.jsxs)(t.p,{children:[`Use `,(0,M.jsx)(t.code,{children:`startName`}),` and `,(0,M.jsx)(t.code,{children:`endName`}),` to submit each thumb as a separate form value.`]}),`
...
`,(0,M.jsxs)(t.p,{children:[`Set `,(0,M.jsx)(t.code,{children:`markers`}),` to render one marker for every valid step beginning at `,(0,M.jsx)(t.code,{children:`minValue`}),`. Markers and thumbs share the same scale and remain aligned. `,(0,M.jsx)(t.code,{children:`minValue`}),`, `,(0,M.jsx)(t.code,{children:`maxValue`}),`, and `,(0,M.jsx)(t.code,{children:`step`}),` determine the marker positions.`]}),`
...
`]}),`
`,(0,M.jsxs)(t.p,{children:[`Thumb labels should describe meaning rather than repeat the current numbers. `,(0,M.jsx)(t.code,{children:`startName`}),` and `,(0,M.jsx)(t.code,{children:`endName`}),` configure form submission; they are not accessible labels.`]}),`
...
`,(0,M.jsx)(t.h3,{id:`instructions-required-state-and-errors`,children:`Instructions, required state, and errors`}),`
`,(0,M.jsxs)(t.p,{children:[`Use `,(0,M.jsx)(t.code,{children:`description`}),` for persistent guidance that applies to the range. Set `,(0,M.jsx)(t.code,{children:`isRequired`}),` when a selection is required, and use `,(0,M.jsx)(t.code,{children:`errorMessage`}),` with the component's validation state to explain how to correct an invalid range. React Aria associates this content with the control.`]}),`
`,(0,M.jsx)(t.h3,{id:`disabled-state`,children:`Disabled state`}),`
`,(0,M.jsxs)(t.p,{children:[(0,M.jsx)(t.code,{children:`isDisabled`}),` prevents interaction with both thumbs and exposes the disabled state semantically. Only the slider control is visually muted; the label, endpoint labels, description, and error text remain readable.`]}),`
...
`,(0,M.jsxs)(t.li,{children:[`Use `,(0,M.jsx)(t.code,{children:`startName`}),` and `,(0,M.jsx)(t.code,{children:`endName`}),` when a native form must submit both values. Choose stable, unique names that match the receiving API.`]}),`
...
`,(0,M.jsxs)(t.p,{children:[`Set `,(0,M.jsx)(t.code,{children:`startName`}),` and `,(0,M.jsx)(t.code,{children:`endName`}),` to the field names expected by the form handler. They may be provided independently, but each submitted value needs its own unique name. Remember that these props do not replace `,(0,M.jsx)(t.code,{children:`thumbLabels`}),`.`]}),`
