import{i as e}from"./preload-helper-DvdRENtr.js";import{y as t}from"./iframe-DhuG6jpW.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-D8d9ding.js";import{t as c}from"./mdx-react-shim-BOtSxo7g.js";import{Controlled as l,Default as u,Disabled as d,Labels as f,Markers as p,Props as m,Range as h,n as g,t as _}from"./range-field.stories-Ds5w7Ezt.js";var v,y=e((()=>{v=`import { RangeField } from '@godaddy/antares';
...
`,(0,M.jsx)(t.li,{children:`Optional localized value output, endpoint labels, description, error message, and markers`}),`
...
`,(0,M.jsxs)(t.p,{children:[`Set `,(0,M.jsx)(t.code,{children:`markers`}),` to render one marker for every valid step beginning at `,(0,M.jsx)(t.code,{children:`minValue`}),`. Marker positions use the same scale as every thumb. `,(0,M.jsx)(t.code,{children:`minValue`}),`, `,(0,M.jsx)(t.code,{children:`maxValue`}),`, and `,(0,M.jsx)(t.code,{children:`step`}),` determine their count and spacing; `,(0,M.jsx)(t.code,{children:`markers`}),` does not accept a custom list or count.`]}),`
...
`,(0,M.jsxs)(t.p,{children:[`Use `,(0,M.jsx)(t.code,{children:`description`}),` for persistent guidance that applies to every thumb. Set `,(0,M.jsx)(t.code,{children:`isRequired`}),` when the field is required, and use `,(0,M.jsx)(t.code,{children:`errorMessage`}),` with the component's validation state to explain how to correct an invalid selection. React Aria associates this content with the control; write errors that identify both the affected value and the corrective action when multiple thumbs are present.`]}),`
`,(0,M.jsx)(t.h3,{id:`disabled-state`,children:`Disabled state`}),`
`,(0,M.jsxs)(t.p,{children:[(0,M.jsx)(t.code,{children:`isDisabled`}),` prevents interaction with every thumb and exposes the disabled state semantically. The slider control is visually muted while the label, endpoint labels, description, and error text remain readable.`]}),`
