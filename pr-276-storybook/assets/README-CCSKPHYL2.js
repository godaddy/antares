import{i as e}from"./preload-helper-DvdRENtr.js";import{y as t}from"./iframe-6FzX8S1w.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-CNIs2f1z.js";import{t as c}from"./mdx-react-shim-DoJ2Y2VX.js";import{Controlled as l,Default as u,Disabled as d,Labels as f,Markers as p,Props as m,n as h,t as g}from"./slider.stories-uNzoZ9dE.js";var _,v=e((()=>{_=`import { Slider, type SliderProps } from '@godaddy/antares';
...
`,(0,k.jsx)(t.li,{children:`Optional localized value output, endpoint labels, and description`}),`
...
`,(0,k.jsx)(t.h3,{id:`instructions-and-required-state`,children:`Instructions and required state`}),`
`,(0,k.jsxs)(t.p,{children:[`Use `,(0,k.jsx)(t.code,{children:`description`}),` for persistent guidance that helps users make a selection. React Aria associates it with the slider thumb. Set `,(0,k.jsx)(t.code,{children:`isRequired`}),` to display the required indicator in the visible label.`]}),`
`,(0,k.jsx)(t.h3,{id:`disabled-state`,children:`Disabled state`}),`
`,(0,k.jsxs)(t.p,{children:[(0,k.jsx)(t.code,{children:`isDisabled`}),` prevents pointer and keyboard changes and exposes the disabled state semantically. The slider control is visually muted while its label, endpoint labels, and description remain readable.`]}),`
