import{i as e}from"./preload-helper-dt_jKsAq.js";import{y as t}from"./iframe-B43ena-z.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-BBCJQbpa.js";import{t as c}from"./mdx-react-shim-B-ZZo_TA.js";import{Alignment as l,Default as u,Direction as d,Gap as f,Navbar as p,Props as m,Sidebar as h,Wrap as g,n as _,t as v}from"./flex.stories-xdl2cqhn.js";var y,b=e((()=>{y=`import { Flex, type FlexProps } from '@godaddy/antares';
...
`,(0,F.jsxs)(t.p,{children:[(0,F.jsx)(t.code,{children:`Flex`}),` is a one-dimensional layout component for arranging children in rows or columns with alignment and spacing control. It extends `,(0,F.jsx)(t.code,{children:`Box`}),`, inheriting all `,(0,F.jsx)(t.code,{children:`Box`}),` capabilities (padding, elevation, rounding, self-alignment, and polymorphic `,(0,F.jsx)(t.code,{children:`as`}),` prop).`]}),`
`,(0,F.jsxs)(t.p,{children:[(0,F.jsx)(t.strong,{children:`Recommended default`}),`: Use `,(0,F.jsx)(t.code,{children:`Flex`}),` for most layouts. Since it extends `,(0,F.jsx)(t.code,{children:`Box`}),`, you get all `,(0,F.jsx)(t.code,{children:`Box`}),` capabilities without needing to nest components.`]}),`
