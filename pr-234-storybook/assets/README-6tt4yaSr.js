import{i as e}from"./preload-helper-DOdH0sfz.js";import{y as t}from"./iframe-6Sk5eqT4.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-MBNUk1B1.js";import{t as c}from"./mdx-react-shim-JTjH5Fue.js";import{Basic as l,IconAccessories as u,LeadingControl as d,Props as f,TrailingControl as p,n as m,t as h}from"./field.stories-CCuT97hK.js";var g,_=e((()=>{g=`import {
  Field,
  FieldButton,
  FieldDescription,
  FieldGroup,
...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldInput`})}),` / `,(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldTextArea`})}),` — the normalized fill controls (React Aria `,(0,w.jsx)(t.code,{children:`Input`}),`/`,(0,w.jsx)(t.code,{children:`TextArea`}),` given antares spacing via `,(0,w.jsx)(t.code,{children:`Box`}),`).`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldButton`})}),` — a click target inside the group (NumberField steppers, search submit, etc.).`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.strong,{children:(0,w.jsx)(t.code,{children:`FieldSelectFragment`})}),` — a Select trigger (current value + chevron) without its own provider or popover, for compositing a Select inside a shared box.`]}),`
