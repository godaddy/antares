import{i as e}from"./preload-helper-rvmC_k-r.js";import{F as t}from"./iframe-BglGQnO6.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-C9ANTrZh.js";import{t as c}from"./mdx-react-shim-DljFPTnZ.js";import{t as l}from"./runtime-BGRM9T0I.js";import{ChipButtonProps as u,ChipGroupProps as d,ChipListProps as f,ControlledSelection as p,Default as m,Disabled as h,EmptyState as g,MenuFilterTrigger as _,Props as v,RemovableChips as y,Sizes as b,ToggleChips as x,Truncation as S,n as C,t as w}from"./chip.stories-DV4VT534.js";function T(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(o,{of:w,name:`Overview`}),`
...
`,(0,D.jsxs)(t.p,{children:[`Use Toggle Chips for multiple peer filters. The Chip render prop supplies
selection state for the checkmark, while `,(0,D.jsx)(t.code,{children:`textValue`}),` names composed content.`]}),`
...
`,(0,D.jsxs)(t.p,{children:[`Use Removable Chips for user-added filters and tokens. `,(0,D.jsx)(t.code,{children:`ChipGroup`}),` reports
removed keys through `,(0,D.jsx)(t.code,{children:`onRemove`}),`; the owner updates its collection. A
self-closing `,(0,D.jsx)(t.code,{children:`Button`}),` in the `,(0,D.jsx)(t.code,{children:`remove`}),` slot supplies each remove control.`]}),`
...
`,(0,D.jsxs)(t.p,{children:[`Compare the supported `,(0,D.jsx)(t.code,{children:`sm`}),`, `,(0,D.jsx)(t.code,{children:`md`}),`, and `,(0,D.jsx)(t.code,{children:`lg`}),` sizes. Set `,(0,D.jsx)(t.code,{children:`size`}),` on `,(0,D.jsx)(t.code,{children:`ChipGroup`}),`
...
`,(0,D.jsxs)(t.p,{children:[`Use `,(0,D.jsx)(t.code,{children:`ChipButton`}),` for Chip presentation without collection semantics.
`,(0,D.jsx)(t.code,{children:`MenuTrigger`}),` continues to own open state, focus, and keyboard behavior.`]}),`
...
`,(0,D.jsx)(t.h3,{id:`content`,children:`Content`}),`
`,(0,D.jsxs)(t.p,{children:[`Use a string for a simple label. For icons or other composed content, wrap the
visible label in `,(0,D.jsx)(t.code,{children:`Text`}),` and provide `,(0,D.jsx)(t.code,{children:`textValue`}),` for the accessible name. See
`,(0,D.jsx)(t.strong,{children:`Toggle Chips`}),` and `,(0,D.jsx)(t.strong,{children:`Removable Chips`}),` above.`]}),`
`,(0,D.jsx)(t.h3,{id:`selection-and-removal`,children:`Selection and removal`}),`
`,(0,D.jsxs)(t.p,{children:[(0,D.jsx)(t.code,{children:`ChipGroup`}),` owns selection and removal behavior. Use a Chip render prop for
state-dependent content, and `,(0,D.jsx)(t.code,{children:`Button`}),` with `,(0,D.jsx)(t.code,{children:`slot="remove"`}),` together with
`,(0,D.jsx)(t.code,{children:`onRemove`}),` for removable items. See `,(0,D.jsx)(t.strong,{children:`Toggle Chips`}),` and `,(0,D.jsx)(t.strong,{children:`Removable Chips`}),`.`]}),`
`,(0,D.jsx)(t.h3,{id:`layout-and-sizing`,children:`Layout and sizing`}),`
`,(0,D.jsxs)(t.p,{children:[`Set `,(0,D.jsx)(t.code,{children:`size`}),` on `,(0,D.jsx)(t.code,{children:`ChipGroup`}),` to keep a collection consistent. `,(0,D.jsx)(t.code,{children:`ChipList`}),` wraps by
default and accepts layout props for custom arrangements. See `,(0,D.jsx)(t.strong,{children:`Sizes`}),`.`]}),`
`,(0,D.jsx)(t.h3,{id:`button-composition`,children:`Button composition`}),`
`,(0,D.jsxs)(t.p,{children:[`Use `,(0,D.jsx)(t.code,{children:`ChipButton`}),` when Chip presentation is needed without collection semantics.
Compose it with components such as `,(0,D.jsx)(t.code,{children:`MenuTrigger`}),`; those components continue to
own open state, focus, and keyboard behavior. See `,(0,D.jsx)(t.strong,{children:`Menu filter trigger`}),`.`]}),`
`,(0,D.jsx)(t.h2,{id:`accessibility`,children:`Accessibility`}),`
`,(0,D.jsxs)(t.ul,{children:[`
`,(0,D.jsxs)(t.li,{children:[`Use `,(0,D.jsx)(t.code,{children:`Label`}),` or `,(0,D.jsx)(t.code,{children:`aria-label`}),` to name the `,(0,D.jsx)(t.code,{children:`ChipGroup`}),`; this names the collection,
not its individual Chips.`]}),`
`,(0,D.jsxs)(t.li,{children:[`Give each Chip a visible label, `,(0,D.jsx)(t.code,{children:`textValue`}),`, or `,(0,D.jsx)(t.code,{children:`aria-label`}),`. Use `,(0,D.jsx)(t.code,{children:`textValue`}),`
...
`,(0,D.jsx)(t.h3,{id:`a-chipgroup-has-no-accessible-name`,children:`A ChipGroup has no accessible name`}),`
`,(0,D.jsxs)(t.p,{children:[`Add a visible `,(0,D.jsx)(t.code,{children:`Label`}),` to the group or provide `,(0,D.jsx)(t.code,{children:`aria-label`}),`. For an individual Chip
with composed content, provide a visible label, `,(0,D.jsx)(t.code,{children:`textValue`}),`, or `,(0,D.jsx)(t.code,{children:`aria-label`}),`.`]}),`
