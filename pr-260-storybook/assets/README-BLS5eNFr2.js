import{i as e}from"./preload-helper-DPdjVz-1.js";import{y as t}from"./iframe-CEg0SMdo.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-BRq_dAW6.js";import{t as c}from"./mdx-react-shim-Cpfjgbns.js";import{Basic as l,Controlled as u,Disabled as d,Invalid as f,Props as p,Sizes as m,n as h,t as g}from"./telephone-field.stories-C0YEsJMR.js";var _,v=e((()=>{_=`import { SelectItem, TelephoneField } from '@godaddy/antares';
...
`,(0,k.jsxs)(t.li,{children:[(0,k.jsx)(t.code,{children:`isDisabled`}),` disables both controls. `,(0,k.jsx)(t.code,{children:`isReadOnly`}),` keeps the phone number focusable but prevents changes to both the phone number and country. `,(0,k.jsx)(t.code,{children:`isInvalid`}),` marks the phone input and shared field as invalid; if the country selection is independently invalid, pass `,(0,k.jsx)(t.code,{children:`countryProps={{ isInvalid: true }}`})]}),`
`]}),`
