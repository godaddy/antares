import{i as e}from"./preload-helper-DPdjVz-1.js";import{y as t}from"./iframe-KnVCKaDX.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DIKQOi_T.js";import{t as c}from"./mdx-react-shim-Bn-QOxMl.js";import{Alignment as l,Areas as u,Columns as d,Default as f,Form as p,Gap as m,Props as h,Responsive as g,n as _,t as v}from"./grid.stories-ClA_Ij23.js";var y,b=e((()=>{y=`import { Grid, Flex, type GridProps } from '@godaddy/antares';
...
`,(0,F.jsxs)(t.p,{children:[(0,F.jsx)(t.code,{children:`Grid`}),` is a two-dimensional CSS Grid layout component for complex grid-based layouts. It extends `,(0,F.jsx)(t.code,{children:`Box`}),`, inheriting all `,(0,F.jsx)(t.code,{children:`Box`}),` capabilities (padding, elevation, rounding, self-alignment, and polymorphic `,(0,F.jsx)(t.code,{children:`as`}),` prop).`]}),`
`,(0,F.jsxs)(t.p,{children:[(0,F.jsxs)(t.strong,{children:[`Use `,(0,F.jsx)(t.code,{children:`Grid`}),` when`]}),`: You need explicit two-dimensional layouts with rows and columns, named grid areas, or responsive auto-fill patterns.`]}),`
