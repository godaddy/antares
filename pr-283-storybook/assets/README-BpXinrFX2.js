import{i as e}from"./preload-helper-DEA0MoIu.js";import{y as t}from"./iframe-CBc7Pisw.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-EUKpiyY0.js";import{t as c}from"./mdx-react-shim-HNeZ3ehM.js";import{Default as l,Props as u,SelectControlled as d,SelectDisabled as f,SelectForm as p,SelectInvalid as m,SelectMultiple as h,SelectSizes as g,n as _,t as v}from"./select.stories-CDxCLMrJ.js";function y(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(o,{of:_,name:`Overview`}),`
`,(0,x.jsx)(t.h1,{id:`select`,children:`Select`}),`
`,(0,x.jsx)(t.p,{children:`Select is a dropdown for picking one or more values from a list of options. It renders a labeled trigger and a popover listbox, supports single and multiple selection, and submits naturally inside a form.`}),`
...
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:`Single or multiple selection`}),`: Set `,(0,x.jsx)(t.code,{children:`selectionMode="multiple"`}),` to allow multiple values`]}),`
...
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:`Form integration`}),`: Set `,(0,x.jsx)(t.code,{children:`name`}),` and the value submits as part of a native `,(0,x.jsx)(t.code,{children:`<form>`}),` (multiple values submit as repeated entries)`]}),`
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:`React Aria integration`}),`: Built on React Aria Select for accessibility, keyboard navigation, and typeahead`]}),`
`]}),`
...
`,(0,x.jsx)(t.p,{children:`Minimal usage with a label and a placeholder.`}),`
`,(0,x.jsx)(i,{of:l,inline:!0}),`
`,(0,x.jsx)(r,{code:`import { Select, SelectItem, type SelectProps } from '@godaddy/antares';
...
`,(0,x.jsx)(t.h3,{id:`select-controlled`,children:`Select Controlled`}),`
...
`,(0,x.jsx)(t.h3,{id:`select-multiple`,children:`Select Multiple`}),`
`,(0,x.jsxs)(t.p,{children:[`Set `,(0,x.jsx)(t.code,{children:`selectionMode="multiple"`}),` to allow multiple values. `,(0,x.jsx)(t.code,{children:`value`}),` is an array of keys.`]}),`
...
`,(0,x.jsx)(t.h3,{id:`select-invalid`,children:`Select Invalid`}),`
...
`,(0,x.jsx)(r,{code:`import { Select, SelectItem } from '@godaddy/antares';
...
`,(0,x.jsx)(t.h3,{id:`select-disabled`,children:`Select Disabled`}),`
`,(0,x.jsxs)(t.p,{children:[`Use `,(0,x.jsx)(t.code,{children:`isDisabled`}),` to prevent interaction.`]}),`
...
`,(0,x.jsx)(t.h3,{id:`select-form`,children:`Select Form`}),`
`,(0,x.jsxs)(t.p,{children:[`Set `,(0,x.jsx)(t.code,{children:`name`}),` to submit the value with a native `,(0,x.jsx)(t.code,{children:`<form>`}),`. Multiple-mode values submit as repeated entries with the same `,(0,x.jsx)(t.code,{children:`name`}),`.`]}),`
`,(0,x.jsx)(i,{of:p,inline:!0}),`
`,(0,x.jsx)(r,{code:`import { useState, type FormEvent } from 'react';
...
`,(0,x.jsx)(r,{code:`import { Flex, Select, SelectItem } from '@godaddy/antares';
...
`,(0,x.jsxs)(t.p,{children:[`The `,(0,x.jsx)(t.code,{children:`Select`}),` component accepts the following props:`]}),`
