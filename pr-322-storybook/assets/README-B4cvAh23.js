import{i as e}from"./preload-helper-BPzpAaEy.js";import{F as t}from"./iframe-DQS4sKb6.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-B6_3uZtw.js";import{t as c}from"./mdx-react-shim-CWAgtcId.js";import{t as l}from"./runtime-C3WRbFCw.js";import{CheckboxIndicatorProps as u,Controlled as d,Default as f,Disabled as p,Group as m,GroupProps as h,Horizontal as g,Indeterminate as _,Invalid as v,Props as y,Required as b,n as x,t as S}from"./checkbox.stories-BRIbES9b.js";function C(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(o,{of:S,name:`Overview`}),`
...
`,(0,T.jsx)(t.p,{children:`Group multiple checkboxes together with a shared label.`}),`
`,(0,T.jsx)(i,{of:m,inline:!0}),`
`,(0,T.jsx)(r,{code:`import { Checkbox, CheckboxGroup, Group, Label } from '@godaddy/antares';
...
`,(0,T.jsx)(r,{code:`import { Checkbox, CheckboxGroup, Group, Label, Text } from '@godaddy/antares';
...
`,(0,T.jsx)(r,{code:`import { Checkbox, CheckboxGroup, FieldError, Group, Label, Text } from '@godaddy/antares';
...
`,(0,T.jsxs)(t.p,{children:[(0,T.jsx)(t.code,{children:`CheckboxGroup`}),` is composed: write `,(0,T.jsx)(t.code,{children:`Label`}),`, a `,(0,T.jsx)(t.code,{children:`Group`}),` holding the `,(0,T.jsx)(t.code,{children:`Checkbox`}),` items, `,(0,T.jsx)(t.code,{children:`Text slot="description"`}),`, and `,(0,T.jsx)(t.code,{children:`FieldError`}),`. The `,(0,T.jsx)(t.code,{children:`Group`}),` takes its axis, gap, and presentational role from the group's `,(0,T.jsx)(t.code,{children:`orientation`}),`, so a bare `,(0,T.jsx)(t.code,{children:`<Group>`}),` is all you need; pass your own `,(0,T.jsx)(t.code,{children:`direction`}),`/`,(0,T.jsx)(t.code,{children:`gap`}),` to lay the items out differently. Each `,(0,T.jsx)(t.code,{children:`Checkbox`}),` takes label text next to the indicator.`]}),`
...
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup className="custom-checkbox-group">
...
`,(0,T.jsxs)(t.li,{children:[(0,T.jsx)(t.strong,{children:(0,T.jsx)(t.code,{children:`FieldError`})}),`: Displays validation error text below the group`]}),`
`]}),`
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup isRequired isInvalid={!hasSelection}>
...
`,(0,T.jsxs)(t.p,{children:[`Use `,(0,T.jsx)(t.code,{children:`orientation="vertical"`}),` (default) to stack checkboxes, or `,(0,T.jsx)(t.code,{children:`orientation="horizontal"`}),` to arrange them in a row.`]}),`
...
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-jsx`,children:`<CheckboxGroup isRequired isInvalid={!agreedToTerms}>
...
`,(0,T.jsx)(t.pre,{children:(0,T.jsx)(t.code,{className:`language-tsx`,children:`<CheckboxGroup>
  <Label />
  <Group>
    <Checkbox />
  </Group>
...
`})}),`
`,(0,T.jsx)(t.h3,{id:`checkbox-1`,children:`Checkbox`}),`
`,(0,T.jsx)(a,{of:y}),`
`,(0,T.jsx)(t.h3,{id:`checkboxgroup`,children:`CheckboxGroup`}),`
`,(0,T.jsx)(a,{of:h}),`
`,(0,T.jsx)(t.h3,{id:`checkboxindicator`,children:`CheckboxIndicator`}),`
`,(0,T.jsx)(a,{of:u})]})}function w(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,T.jsx)(t,{...e,children:(0,T.jsx)(C,{...e})}):C(e)}var T;e((()=>{T=t(),c(),s(),l(),x()}))();export{w as default};