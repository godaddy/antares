import{i as e}from"./preload-helper-BPzpAaEy.js";import{F as t}from"./iframe-DQS4sKb6.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-B6_3uZtw.js";import{t as c}from"./mdx-react-shim-CWAgtcId.js";import{t as l}from"./runtime-C3WRbFCw.js";import{BandPadding as u,Baselines as d,BitcoinPrice as f,BrowserUsage as p,CityTemperature as m,ColorIndex as h,CrosshairOnly as g,CustomAccessors as _,CustomTicks as v,CustomTooltip as y,CustomTooltipFormatting as b,CustomTooltipPairChange as x,CustomTooltipPeriodComparison as S,Default as C,FixedDomain as w,FixedSize as T,Formatting as E,Gridlines as D,Labels as O,Legend as k,LineStyles as A,MissingValues as j,MultipleSeries as M,NiceValues as N,Props as P,RTL as F,Ticks as I,Titles as L,TooltipDisabled as R,ZeroIncluded as z,n as B,t as V}from"./line-chart.stories-CLOL4RRR.js";function H(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,W.jsxs)(W.Fragment,{children:[(0,W.jsx)(o,{of:B,name:`Overview`}),`
`,(0,W.jsx)(t.h1,{id:`linechart`,children:`LineChart`}),`
`,(0,W.jsx)(t.p,{children:`Line Chart shows how something changes over time or along a continuous scale. It connects data points with lines so people can quickly spot trends, peaks, dips, and patterns.`}),`
...
`,(0,W.jsxs)(t.p,{children:[`One line, a time-scale X axis, and almost nothing else configured - the everyday starting point. You give the chart a `,(0,W.jsx)(t.code,{children:`series`}),` array and it reads `,(0,W.jsx)(t.code,{children:`x`}),`/`,(0,W.jsx)(t.code,{children:`y`}),` from each point.`]}),`
`,(0,W.jsx)(i,{of:C,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
...
`,(0,W.jsx)(t.h3,{id:`multiple-series`,children:`Multiple series`}),`
`,(0,W.jsx)(t.p,{children:`Several lines sharing one X axis, with a legend naming each of them. Reach for this when the comparison between series is the story.`}),`
...
`,(0,W.jsx)(t.h3,{id:`gridlines`,children:`Gridlines`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xGridlines`}),` and `,(0,W.jsx)(t.code,{children:`yGridlines`}),` add faint lines across the plot so it is easier to read a value back off an axis.`]}),`
...
`,(0,W.jsx)(t.h3,{id:`titles`,children:`Titles`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xTitle`}),` and `,(0,W.jsx)(t.code,{children:`yTitle`}),` label what each axis actually measures, e.g. "Month" and "Temperature (°F)".`]}),`
...
`,(0,W.jsx)(t.h3,{id:`labels`,children:`Labels`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xLabels`}),` and `,(0,W.jsx)(t.code,{children:`yLabels`}),` toggle the tick labels on each axis. Turn them off for sparklines or when the surrounding UI already names the values.`]}),`
`,(0,W.jsx)(i,{of:O,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`ticks`,children:`Ticks`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xTickMarks`}),` and `,(0,W.jsx)(t.code,{children:`yTickMarks`}),` draw the short lines at each tick value, which helps tie a label to its exact position on the axis.`]}),`
`,(0,W.jsx)(i,{of:I,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`baselines`,children:`Baselines`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xBaseline`}),` and `,(0,W.jsx)(t.code,{children:`yBaseline`}),` control the main axis lines themselves. Dropping them gives a lighter, more editorial chart.`]}),`
`,(0,W.jsx)(i,{of:d,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`legend`,children:`Legend`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`legendPosition`}),` puts the legend above or below the plot, or hides it with `,(0,W.jsx)(t.code,{children:`null`}),`. Multi-series charts get a bottom legend by default.`]}),`
`,(0,W.jsx)(i,{of:k,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`axis-and-tooltip-formatting`,children:`Axis and tooltip formatting`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xTickFormat`}),` and `,(0,W.jsx)(t.code,{children:`yTickFormat`}),` shape the axis labels - dates, currency, units, percentages - and the tooltip follows the same formatting.`]}),`
`,(0,W.jsx)(i,{of:E,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
...
`,(0,W.jsx)(t.h3,{id:`custom-accessors`,children:`Custom accessors`}),`
`,(0,W.jsxs)(t.p,{children:[`When your data does not use `,(0,W.jsx)(t.code,{children:`x`}),`/`,(0,W.jsx)(t.code,{children:`y`}),`, point `,(0,W.jsx)(t.code,{children:`xAccessor`}),` and `,(0,W.jsx)(t.code,{children:`yAccessor`}),` at the fields it does use (here `,(0,W.jsx)(t.code,{children:`date`}),` and `,(0,W.jsx)(t.code,{children:`value`}),`) instead of reshaping the data first.`]}),`
`,(0,W.jsx)(i,{of:_,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { type DateValue, cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`missing-values`,children:`Missing values`}),`
`,(0,W.jsxs)(t.p,{children:[`A `,(0,W.jsx)(t.code,{children:`null`}),` Y value breaks the line instead of drawing through the gap, so missing data reads as missing rather than as a straight interpolation.`]}),`
`,(0,W.jsx)(i,{of:j,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { appleStock } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`fixed-domain`,children:`Fixed domain`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xDomain`}),` and `,(0,W.jsx)(t.code,{children:`yDomain`}),` pin the visible range. Use them to keep a fixed scale, or to keep several charts comparable.`]}),`
`,(0,W.jsx)(i,{of:w,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { appleStock } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`nice-values`,children:`Nice values`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xNice`}),` and `,(0,W.jsx)(t.code,{children:`yNice`}),` round the domain out to friendlier numbers (e.g. 0.2 to 1.0), so ticks land on values people expect.`]}),`
`,(0,W.jsx)(i,{of:N,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`zero-included`,children:`Zero included`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xZero`}),` and `,(0,W.jsx)(t.code,{children:`yZero`}),` stretch the domain to include zero. Worth doing when the absolute size of the values matters, not just their movement.`]}),`
`,(0,W.jsx)(i,{of:z,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { appleStock } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`custom-ticks`,children:`Custom ticks`}),`
`,(0,W.jsxs)(t.p,{children:[`Choose the ticks yourself with `,(0,W.jsx)(t.code,{children:`xTickValues`}),`/`,(0,W.jsx)(t.code,{children:`yTickValues`}),`, or just ask for roughly how many you want with `,(0,W.jsx)(t.code,{children:`xNumTicks`}),`/`,(0,W.jsx)(t.code,{children:`yNumTicks`}),`.`]}),`
...
`,(0,W.jsx)(t.h3,{id:`band-padding`,children:`Band padding`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`xPaddingOuter`}),` and `,(0,W.jsx)(t.code,{children:`yPaddingOuter`}),` add breathing room at the ends of a band or point scale so the first and last values are not pinned to the edges.`]}),`
`,(0,W.jsx)(i,{of:u,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`tooltip-disabled`,children:`Tooltip disabled`}),`
`,(0,W.jsxs)(t.p,{children:[`Turn off the hover affordances entirely with `,(0,W.jsx)(t.code,{children:`tooltip={false}`}),`, `,(0,W.jsx)(t.code,{children:`showCrosshair={false}`}),`, and `,(0,W.jsx)(t.code,{children:`showDataPoints={false}`}),` - useful for a static or print-style chart.`]}),`
`,(0,W.jsx)(i,{of:R,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`crosshair-only`,children:`Crosshair only`}),`
`,(0,W.jsx)(t.p,{children:`Keep the vertical crosshair for orientation while hiding the tooltip and the data point glyphs.`}),`
...
`,(0,W.jsx)(t.h3,{id:`custom-tooltip-formatting`,children:`Custom tooltip formatting`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`tooltipValueFormatter`}),` shapes only the tooltip values, so you can show full currency or units there while the axis stays compact.`]}),`
`,(0,W.jsx)(i,{of:b,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps, type DataPoint } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`fixed-size`,children:`Fixed size`}),`
`,(0,W.jsxs)(t.p,{children:[`Pass `,(0,W.jsx)(t.code,{children:`width`}),` and `,(0,W.jsx)(t.code,{children:`height`}),` to size the chart explicitly instead of letting it fill its container.`]}),`
`,(0,W.jsx)(i,{of:T,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`bitcoin-price`,children:`Bitcoin price`}),`
`,(0,W.jsx)(t.p,{children:`A real time series: date formatting on the X axis, currency on the Y axis, gridlines, and a nice-rounded domain.`}),`
`,(0,W.jsx)(i,{of:f,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { bitcoinPrice } from '@visx/mock-data';
import { LineChart, type LineChartProps, type DataPoint } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`city-temperature`,children:`City temperature`}),`
`,(0,W.jsx)(t.p,{children:`Several cities over the same period, with a legend and a shared time axis - the multi-series case as it usually looks in a product.`}),`
`,(0,W.jsx)(i,{of:m,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps, type DataPoint } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`browser-usage`,children:`Browser usage`}),`
`,(0,W.jsx)(t.p,{children:`A categorical X axis (band scale) with several series and percentage formatting, for when the X values are names rather than numbers or dates.`}),`
`,(0,W.jsx)(i,{of:p,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { browserUsage } from '@visx/mock-data';
import { LineChart, type LineChartProps, type DataPoint } from '@godaddy/antares';
...
`,(0,W.jsx)(t.h3,{id:`rtl`,children:`RTL`}),`
`,(0,W.jsx)(t.p,{children:`The chart follows the current layout direction, normally detected from the browser or system settings. In right-to-left it mirrors the axes and labels; this example forces RTL so you can see it in a left-to-right page.`}),`
`,(0,W.jsx)(i,{of:F,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { RTLProvider } from '#utils/rtl-locale-provider.tsx';
...
`,(0,W.jsx)(t.h3,{id:`color-index`,children:`Color Index`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`colorIndex`}),` pins each series to a palette color. Any series can use any index,
...
`,(0,W.jsx)(t.h3,{id:`custom-tooltip`,children:`Custom Tooltip`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`renderTooltip`}),` lets you render a fully custom tooltip and know which curve is
hovered. Paired series share a `,(0,W.jsx)(t.code,{children:`colorIndex`}),`; hovering either line shows a
...
`,(0,W.jsx)(t.h3,{id:`custom-tooltip-pair-change`,children:`Custom Tooltip Pair Change`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`renderTooltip`}),` example combining a pair of series. Each pair shares a `,(0,W.jsx)(t.code,{children:`colorIndex`}),`
...
`,(0,W.jsx)(t.h3,{id:`custom-tooltip-period-comparison`,children:`Custom Tooltip Period Comparison`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`renderTooltip`}),` example styled as a period-over-period comparison card. Paired series
(solid current period + dashed previous period) share a `,(0,W.jsx)(t.code,{children:`colorIndex`}),`; hovering either
line shows both dated values and the percent change, wrapped in the default popover.`]}),`
`,(0,W.jsx)(i,{of:S,inline:!0}),`
...
`,(0,W.jsx)(t.h3,{id:`line-styles`,children:`Line Styles`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.code,{children:`variant`}),` sets each series' line style — 'solid' (default), 'dashed', or
'dotted' — useful for distinguishing actuals from forecasts or targets. The
legend swatch mirrors each line's style.`]}),`
`,(0,W.jsx)(i,{of:A,inline:!0}),`
`,(0,W.jsx)(r,{code:`import { cityTemperature } from '@visx/mock-data';
import { LineChart, type LineChartProps } from '@godaddy/antares';
...
`,(0,W.jsx)(t.p,{children:`The chart root exposes data attributes that reflect prop state for styling:`}),`
`,(0,W.jsxs)(t.p,{children:[(0,W.jsx)(t.strong,{children:`Chart container:`}),` `,(0,W.jsx)(t.code,{children:`data-width`}),`, `,(0,W.jsx)(t.code,{children:`data-height`}),`, `,(0,W.jsx)(t.code,{children:`data-x-labels`}),`, `,(0,W.jsx)(t.code,{children:`data-y-labels`}),`, `,(0,W.jsx)(t.code,{children:`data-x-labels-vertical`}),`, `,(0,W.jsx)(t.code,{children:`data-x-baseline`}),`, `,(0,W.jsx)(t.code,{children:`data-y-baseline`}),`, `,(0,W.jsx)(t.code,{children:`data-x-tick-marks`}),`, `,(0,W.jsx)(t.code,{children:`data-y-tick-marks`})]}),`
`,(0,W.jsx)(t.h3,{id:`component-customization`,children:`Component Customization`}),`
`,(0,W.jsxs)(t.p,{children:[`Use the `,(0,W.jsx)(t.code,{children:`className`}),` prop on the chart container to add or override styles:`]}),`
`,(0,W.jsx)(t.pre,{children:(0,W.jsx)(t.code,{className:`language-tsx`,children:`<LineChart series={series} className="my-custom-chart" />
`})}),`
...
`,(0,W.jsxs)(t.li,{children:[`Provide `,(0,W.jsx)(t.strong,{children:(0,W.jsx)(t.code,{children:`aria-label`})}),` to describe the chart (e.g. "Monthly sales revenue from January to May 2024").`]}),`
`,(0,W.jsxs)(t.li,{children:[`Use `,(0,W.jsx)(t.strong,{children:(0,W.jsx)(t.code,{children:`desc`})}),` for a longer description rendered in the SVG `,(0,W.jsx)(t.code,{children:`<desc>`}),` for screen readers.`]}),`
`,(0,W.jsx)(t.li,{children:`The component sets ARIA attributes on interactive and structural elements as needed.`}),`
`]}),`
`,(0,W.jsx)(t.h2,{id:`best-practices`,children:`Best Practices`}),`
`,(0,W.jsx)(t.h3,{id:`when-to-use-linechart`,children:`When to Use LineChart`}),`
`,(0,W.jsxs)(t.ul,{children:[`
`,(0,W.jsx)(t.li,{children:`Use for trends over time or along a continuous scale.`}),`
`,(0,W.jsx)(t.li,{children:`Use when comparing a few series (e.g. 2-5 lines); avoid too many overlapping lines.`}),`
`,(0,W.jsx)(t.li,{children:`Prefer a single chart with a legend over multiple small charts when comparing the same X range.`}),`
`]}),`
`,(0,W.jsx)(t.h2,{id:`troubleshooting`,children:`Troubleshooting`}),`
`,(0,W.jsx)(t.h3,{id:`chart-not-sizing-or-empty`,children:`Chart Not Sizing or Empty`}),`
`,(0,W.jsxs)(t.p,{children:[`Ensure the chart has a non-zero size. Place it in a container with explicit dimensions or use `,(0,W.jsx)(t.code,{children:`width`}),` and `,(0,W.jsx)(t.code,{children:`height`}),`:`]}),`
`,(0,W.jsx)(t.pre,{children:(0,W.jsx)(t.code,{className:`language-tsx`,children:`// ✅ Container with size
...
`})}),`
`,(0,W.jsx)(t.h3,{id:`dates-not-displaying-correctly`,children:`Dates Not Displaying Correctly`}),`
`,(0,W.jsxs)(t.p,{children:[`Use `,(0,W.jsx)(t.code,{children:`xType="time"`}),` when the X-axis values are Date objects:`]}),`
`,(0,W.jsx)(t.pre,{children:(0,W.jsx)(t.code,{className:`language-tsx`,children:`// ❌ Without xType="time", Date objects may not scale correctly
<LineChart series={seriesWithDates} />

// ✅ Use time scale for Date X values
<LineChart series={seriesWithDates} xType="time" />
`})}),`
`,(0,W.jsx)(t.h3,{id:`tooltip-or-crosshair-not-showing`,children:`Tooltip or Crosshair Not Showing`}),`
`,(0,W.jsxs)(t.p,{children:[`Ensure `,(0,W.jsx)(t.code,{children:`tooltip`}),`, `,(0,W.jsx)(t.code,{children:`showCrosshair`}),`, or `,(0,W.jsx)(t.code,{children:`showDataPoints`}),` are not set to `,(0,W.jsx)(t.code,{children:`false`}),`, and that the chart receives pointer events (e.g. no overlay blocking hover).`]}),`
`,(0,W.jsx)(t.h2,{id:`props`,children:`Props`}),`
`,(0,W.jsx)(t.h3,{id:`linechart-1`,children:`LineChart`}),`
`,(0,W.jsx)(a,{of:P})]})}function U(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,W.jsx)(t,{...e,children:(0,W.jsx)(H,{...e})}):H(e)}var W;e((()=>{W=t(),c(),s(),l(),V()}))();export{U as default};