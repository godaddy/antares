import{i as e}from"./preload-helper-m4Fz4Gr4.js";import{F as t}from"./iframe-Btr02MyP.js";import{S as n,c as r,l as i,n as a,s as o,u as s}from"./blocks-DJQsdYxO.js";import{t as c}from"./mdx-react-shim-iHRQVTyi.js";import{t as l}from"./runtime-DILVL991.js";import{ButtonGroupProps as u,ContentProps as d,Default as f,FooterProps as p,Group as m,GroupProps as h,HeaderProps as g,n as _,t as v}from"./structure.stories-Rdth4_ME.js";function y(e){let t={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(o,{of:_,name:`Overview`}),`
...
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:(0,x.jsx)(t.code,{children:`ButtonGroup`})}),` - a cluster of related actions (a wrapping row with `,(0,x.jsx)(t.code,{children:`role="group"`}),`). Overlay parents like `,(0,x.jsx)(t.code,{children:`Modal`}),` adopt it with end alignment and padding.`]}),`
`,(0,x.jsxs)(t.li,{children:[(0,x.jsx)(t.strong,{children:(0,x.jsx)(t.code,{children:`Group`})}),` — semantic grouping container for field item controls. A parent field injects the box chrome.`]}),`
`]}),`
